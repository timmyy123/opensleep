...
public final class RequestError implements ClientHook<Function3<? super HttpRequest, ? super Throwable, ? super Continuation<? super Throwable>, ? extends Object>> {
    ...
    @DebugMetadata(c = "io.ktor.client.plugins.RequestError$install$1", f = "HttpCallValidator.kt", l = {134, 136}, m = "invokeSuspend")
    public static final class AnonymousClass1 extends SuspendLambda implements Function3<PipelineContext<Object, HttpRequestBuilder>, Object, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Type inference failed for: r5v0, types: [io.ktor.client.plugins.RequestError$install$1, kotlin.coroutines.Continuation] */
        /* JADX WARN: Type inference failed for: r5v1, types: [io.ktor.client.plugins.RequestError$install$1, java.lang.Object] */
