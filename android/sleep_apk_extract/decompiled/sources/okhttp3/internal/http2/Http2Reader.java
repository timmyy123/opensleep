...
public final class Http2Reader implements Closeable {
    ...
    public static final class Companion {
        ...
        public final int lengthWithoutPadding(int length, int flags, int padding) throws IOException {
            ...
            OggIO$$ExternalSyntheticBUOutline0.m(Fragment$$ExternalSyntheticOutline1.m(padding, length, "PROTOCOL_ERROR padding ", " > remaining length "));
            return 0;
        }
    ...
    @Metadata(d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\b\n\u0002\b\u0013\b\u0000\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\u000f\u0010\u0007\u001a\u00020\u0006H\u0002¢\u0006\u0004\b\u0007\u0010\bJ\u001f\u0010\r\u001a\u00020\u000b2\u0006\u0010\n\u001a\u00020\t2\u0006\u0010\f\u001a\u00020\u000bH\u0016¢\u0006\u0004\b\r\u0010\u000eJ\u000f\u0010\u0010\u001a\u00020\u000fH\u0016¢\u0006\u0004\b\u0010\u0010\u0011J\u000f\u0010\u0012\u001a\u00020\u0006H\u0016¢\u0006\u0004\b\u0012\u0010\bR\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0003\u0010\u0013R\"\u0010\u0015\u001a\u00020\u00148\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u0015\u0010\u0016\u001a\u0004\b\u0017\u0010\u0018\"\u0004\b\u0019\u0010\u001aR\"\u0010\u001b\u001a\u00020\u00148\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u001b\u0010\u0016\u001a\u0004\b\u001c\u0010\u0018\"\u0004\b\u001d\u0010\u001aR\"\u0010\u001e\u001a\u00020\u00148\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u001e\u0010\u0016\u001a\u0004\b\u001f\u0010\u0018\"\u0004\b \u0010\u001aR\"\u0010!\u001a\u00020\u00148\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b!\u0010\u0016\u001a\u0004\b\"\u0010\u0018\"\u0004\b#\u0010\u001aR\"\u0010$\u001a\u00020\u00148\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b$\u0010\u0016\u001a\u0004\b%\u0010\u0018\"\u0004\b&\u0010\u001a¨\u0006'"}, d2 = {"Lokhttp3/internal/http2/Http2Reader$ContinuationSource;", "Lokio/Source;", "Lokio/BufferedSource;", ShareConstants.FEED_SOURCE_PARAM, "<init>", "(Lokio/BufferedSource;)V", "", "readContinuationHeader", "()V", "Lokio/Buffer;", "sink", "", "byteCount", "read", "(Lokio/Buffer;J)J", "Lokio/Timeout;", "timeout", "()Lokio/Timeout;", "close", "Lokio/BufferedSource;", "", "length", "I", "getLength", "()I", "setLength", "(I)V", "flags", "getFlags", "setFlags", "streamId", "getStreamId", "setStreamId", ViewHierarchyConstants.DIMENSION_LEFT_KEY, "getLeft", "setLeft", "padding", "getPadding", "setPadding", "okhttp"}, k = 1, mv = {1, 8, 0}, xi = 48)
    public static final class ContinuationSource implements Source {
        ...
        private final void readContinuationHeader() throws IOException {
            ...
            this.flags = Util.and(this.source.readByte(), PHIpAddressSearchManager.END_IP_SCAN);
            ...
            if (iAnd == 9) {
                ...
                OggIO$$ExternalSyntheticBUOutline0.m("TYPE_CONTINUATION streamId changed");
            } else {
    ...
    @Metadata(d1 = {"\u0000P\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\n\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\t\n\u0002\b\r\bf\u0018\u00002\u00020\u0001J/\u0010\n\u001a\u00020\t2\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\u0004H&¢\u0006\u0004\b\n\u0010\u000bJ5\u0010\u0010\u001a\u00020\t2\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\f\u001a\u00020\u00042\f\u0010\u000f\u001a\b\u0012\u0004\u0012\u00020\u000e0\rH&¢\u0006\u0004\b\u0010\u0010\u0011J\u001f\u0010\u0014\u001a\u00020\t2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0013\u001a\u00020\u0012H&¢\u0006\u0004\b\u0014\u0010\u0015J\u001f\u0010\u0018\u001a\u00020\t2\u0006\u0010\u0016\u001a\u00020\u00022\u0006\u0010\u0018\u001a\u00020\u0017H&¢\u0006\u0004\b\u0018\u0010\u0019J\u000f\u0010\u001a\u001a\u00020\tH&¢\u0006\u0004\b\u001a\u0010\u001bJ'\u0010\u001f\u001a\u00020\t2\u0006\u0010\u001c\u001a\u00020\u00022\u0006\u0010\u001d\u001a\u00020\u00042\u0006\u0010\u001e\u001a\u00020\u0004H&¢\u0006\u0004\b\u001f\u0010 J'\u0010$\u001a\u00020\t2\u0006\u0010!\u001a\u00020\u00042\u0006\u0010\u0013\u001a\u00020\u00122\u0006\u0010#\u001a\u00020\"H&¢\u0006\u0004\b$\u0010%J\u001f\u0010(\u001a\u00020\t2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010'\u001a\u00020&H&¢\u0006\u0004\b(\u0010)J/\u0010-\u001a\u00020\t2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010*\u001a\u00020\u00042\u0006\u0010+\u001a\u00020\u00042\u0006\u0010,\u001a\u00020\u0002H&¢\u0006\u0004\b-\u0010.J-\u00101\u001a\u00020\t2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010/\u001a\u00020\u00042\f\u00100\u001a\b\u0012\u0004\u0012\u00020\u000e0\rH&¢\u0006\u0004\b1\u00102¨\u00063"}, d2 = {"Lokhttp3/internal/http2/Http2Reader$Handler;", "", "", "inFinished", "", "streamId", "Lokio/BufferedSource;", ShareConstants.FEED_SOURCE_PARAM, "length", "", "data", "(ZILokio/BufferedSource;I)V", "associatedStreamId", "", "Lokhttp3/internal/http2/Header;", "headerBlock", "headers", "(ZIILjava/util/List;)V", "Lokhttp3/internal/http2/ErrorCode;", "errorCode", "rstStream", "(ILokhttp3/internal/http2/ErrorCode;)V", "clearPrevious", "Lokhttp3/internal/http2/Settings;", "settings", "(ZLokhttp3/internal/http2/Settings;)V", "ackSettings", "()V", "ack", "payload1", "payload2", "ping", "(ZII)V", "lastGoodStreamId", "Lokio/ByteString;", "debugData", "goAway", "(ILokhttp3/internal/http2/ErrorCode;Lokio/ByteString;)V", "", "windowSizeIncrement", "windowUpdate", "(IJ)V", "streamDependency", "weight", "exclusive", "priority", "(IIIZ)V", "promisedStreamId", "requestHeaders", "pushPromise", "(IILjava/util/List;)V", "okhttp"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    private final void readData(Handler handler, int length, int flags, int streamId) throws IOException {
        if (streamId == 0) {
            OggIO$$ExternalSyntheticBUOutline0.m("PROTOCOL_ERROR: TYPE_DATA streamId == 0");
            return;
        }
        boolean z = (flags & 1) != 0;
        if ((flags & 32) != 0) {
            OggIO$$ExternalSyntheticBUOutline0.m("PROTOCOL_ERROR: FLAG_COMPRESSED without SETTINGS_COMPRESS_DATA");
            return;
        }
        int iAnd = (flags & 8) != 0 ? Util.and(this.source.readByte(), PHIpAddressSearchManager.END_IP_SCAN) : 0;
    ...
    private final void readGoAway(Handler handler, int length, int flags, int streamId) throws IOException {
        if (length < 8) {
            OggIO$$ExternalSyntheticBUOutline0.m(FileInsert$$ExternalSyntheticOutline0.m(length, "TYPE_GOAWAY length < 8: "));
            return;
        }
        if (streamId != 0) {
            OggIO$$ExternalSyntheticBUOutline0.m("TYPE_GOAWAY streamId != 0");
            return;
        }
        ...
        if (errorCodeFromHttp2 == null) {
            OggIO$$ExternalSyntheticBUOutline0.m(FileInsert$$ExternalSyntheticOutline0.m(i2, "TYPE_GOAWAY unexpected error code: "));
            return;
        }
    ...
    private final void readHeaders(Handler handler, int length, int flags, int streamId) throws IOException {
        if (streamId == 0) {
            OggIO$$ExternalSyntheticBUOutline0.m("PROTOCOL_ERROR: TYPE_HEADERS streamId == 0");
            return;
        }
        boolean z = (flags & 1) != 0;
        int iAnd = (flags & 8) != 0 ? Util.and(this.source.readByte(), PHIpAddressSearchManager.END_IP_SCAN) : 0;
    ...
    private final void readPing(Handler handler, int length, int flags, int streamId) throws IOException {
        if (length != 8) {
            OggIO$$ExternalSyntheticBUOutline0.m(FileInsert$$ExternalSyntheticOutline0.m(length, "TYPE_PING length != 8: "));
        } else {
            if (streamId != 0) {
                OggIO$$ExternalSyntheticBUOutline0.m("TYPE_PING streamId != 0");
                return;
            }
    ...
    private final void readPriority(Handler handler, int streamId) {
        int i = this.source.readInt();
        handler.priority(streamId, i & Integer.MAX_VALUE, Util.and(this.source.readByte(), PHIpAddressSearchManager.END_IP_SCAN) + 1, (Integer.MIN_VALUE & i) != 0);
    }

    private final void readPushPromise(Handler handler, int length, int flags, int streamId) throws IOException {
        if (streamId == 0) {
            OggIO$$ExternalSyntheticBUOutline0.m("PROTOCOL_ERROR: TYPE_PUSH_PROMISE streamId == 0");
        } else {
            int iAnd = (flags & 8) != 0 ? Util.and(this.source.readByte(), PHIpAddressSearchManager.END_IP_SCAN) : 0;
    ...
    private final void readRstStream(Handler handler, int length, int flags, int streamId) throws IOException {
        if (length != 4) {
            OggIO$$ExternalSyntheticBUOutline0.m(Fragment$$ExternalSyntheticOutline1.m(length, "TYPE_RST_STREAM length: ", " != 4"));
            return;
        }
        if (streamId == 0) {
            OggIO$$ExternalSyntheticBUOutline0.m("TYPE_RST_STREAM streamId == 0");
            return;
        }
        int i = this.source.readInt();
        ...
        if (errorCodeFromHttp2 != null) {
            ...
            OggIO$$ExternalSyntheticBUOutline0.m(FileInsert$$ExternalSyntheticOutline0.m(i, "TYPE_RST_STREAM unexpected error code: "));
        }
    }
    ...
    private final void readSettings(Handler handler, int length, int flags, int streamId) throws IOException {
        int i;
        if (streamId != 0) {
            OggIO$$ExternalSyntheticBUOutline0.m("TYPE_SETTINGS streamId != 0");
            return;
        }
        if ((flags & 1) != 0) {
            if (length == 0) {
                ...
                OggIO$$ExternalSyntheticBUOutline0.m("FRAME_SIZE_ERROR ack frame should be empty!");
                return;
            }
        }
        if (length % 6 != 0) {
            OggIO$$ExternalSyntheticBUOutline0.m(FileInsert$$ExternalSyntheticOutline0.m(length, "TYPE_SETTINGS length % 6 != 0: "));
            return;
        }
        Settings settings = new Settings();
        IntProgression intProgressionStep = RangesKt___RangesKt.step(RangesKt.until(0, length), 6);
        ...
        if ((step > 0 && first <= last) || (step < 0 && last <= first)) {
            while (true) {
                ...
                if (iAnd != 2) {
                    if (iAnd == 3) {
                        ...
                        if (i < 0) {
                            OggIO$$ExternalSyntheticBUOutline0.m("PROTOCOL_ERROR SETTINGS_INITIAL_WINDOW_SIZE > 2^31 - 1");
                            return;
                        }
                        iAnd = 7;
                    }
                } else if (i != 0 && i != 1) {
                    OggIO$$ExternalSyntheticBUOutline0.m("PROTOCOL_ERROR SETTINGS_ENABLE_PUSH != 0 or 1");
                    return;
                }
                settings.set(iAnd, i);
                if (first == last) {
            ...
            OggIO$$ExternalSyntheticBUOutline0.m(FileInsert$$ExternalSyntheticOutline0.m(i, "PROTOCOL_ERROR SETTINGS_MAX_FRAME_SIZE: "));
            return;
        }
    ...
    private final void readWindowUpdate(Handler handler, int length, int flags, int streamId) throws IOException {
        if (length != 4) {
            OggIO$$ExternalSyntheticBUOutline0.m(FileInsert$$ExternalSyntheticOutline0.m(length, "TYPE_WINDOW_UPDATE length !=4: "));
            return;
        }
        ...
        if (jAnd != 0) {
            ...
            OggIO$$ExternalSyntheticBUOutline0.m("windowSizeIncrement was 0");
        }
    }
    ...
    public final boolean nextFrame(boolean requireSettings, Handler handler) throws IOException {
        ...
        try {
            ...
            int medium = Util.readMedium(this.source);
            if (medium > 16384) {
                OggIO$$ExternalSyntheticBUOutline0.m(FileInsert$$ExternalSyntheticOutline0.m(medium, "FRAME_SIZE_ERROR: "));
                return false;
            }
            int iAnd = Util.and(this.source.readByte(), PHIpAddressSearchManager.END_IP_SCAN);
            int iAnd2 = Util.and(this.source.readByte(), PHIpAddressSearchManager.END_IP_SCAN);
            ...
            if (requireSettings && iAnd != 4) {
                Utf8$$ExternalSyntheticBUOutline0.m$2("Expected a SETTINGS frame but was ", Http2.INSTANCE.formattedType$okhttp(iAnd));
                return false;
            }
            switch (iAnd) {
                case 0:
    ...
    public final void readConnectionPreface(Handler handler) throws IOException {
        ...
        if (this.client) {
            ...
            OggIO$$ExternalSyntheticBUOutline0.m("Required SETTINGS preface not received");
            return;
        }
        BufferedSource bufferedSource = this.source;
        ...
        Utf8$$ExternalSyntheticBUOutline0.m$2("Expected a connection header but was ", byteString2.utf8());
    }

    private final void readPriority(Handler handler, int length, int flags, int streamId) throws IOException {
        if (length != 5) {
            OggIO$$ExternalSyntheticBUOutline0.m(Fragment$$ExternalSyntheticOutline1.m(length, "TYPE_PRIORITY length: ", " != 5"));
        } else if (streamId != 0) {
            readPriority(handler, streamId);
        } else {
            OggIO$$ExternalSyntheticBUOutline0.m("TYPE_PRIORITY streamId == 0");
        }
    }
}
