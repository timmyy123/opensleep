...
public final class JavaNetAuthenticator implements Authenticator {
    ...
    public Request authenticate(Route route, Response response) {
        ...
        for (Challenge challenge : listChallenges) {
            if (StringsKt__StringsJVMKt.equals("Basic", challenge.getScheme(), true)) {
                ...
                if (z) {
                    ...
                    passwordAuthenticationRequestPasswordAuthentication = java.net.Authenticator.requestPasswordAuthentication(inetSocketAddress.getHostName(), connectToInetAddress(proxy, url, dns), inetSocketAddress.getPort(), url.getScheme(), challenge.realm(), challenge.getScheme(), url.url(), Authenticator.RequestorType.PROXY);
                } else {
