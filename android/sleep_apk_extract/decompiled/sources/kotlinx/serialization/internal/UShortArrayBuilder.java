...
public final class UShortArrayBuilder extends PrimitiveArrayBuilder<UShortArray> {
    ...
    private UShortArrayBuilder(short[] sArr) {
        sArr.getClass();
        this.buffer = sArr;
        this.position = UShortArray.m2445getSizeimpl(sArr);
        ensureCapacity$kotlinx_serialization_core(10);
    }

    /* JADX INFO: renamed from: append-xj2QHRw$kotlinx_serialization_core, reason: not valid java name */
    public final void m2655appendxj2QHRw$kotlinx_serialization_core(short c) {
        PrimitiveArrayBuilder.ensureCapacity$kotlinx_serialization_core$default(this, 0, 1, null);
        short[] sArr = this.buffer;
        int position = getPosition();
        this.position = position + 1;
        UShortArray.m2449set01HTLdE(sArr, position, c);
    }

    @Override // kotlinx.serialization.internal.PrimitiveArrayBuilder
    public /* bridge */ /* synthetic */ UShortArray build$kotlinx_serialization_core() {
        return UShortArray.m2438boximpl(m2656buildamswpOA$kotlinx_serialization_core());
    }

    /* JADX INFO: renamed from: build-amswpOA$kotlinx_serialization_core, reason: not valid java name */
    public short[] m2656buildamswpOA$kotlinx_serialization_core() {
        return UShortArray.m2440constructorimpl(Arrays.copyOf(this.buffer, getPosition()));
    }

    @Override // kotlinx.serialization.internal.PrimitiveArrayBuilder
    public void ensureCapacity$kotlinx_serialization_core(int requiredCapacity) {
        if (UShortArray.m2445getSizeimpl(this.buffer) < requiredCapacity) {
            short[] sArr = this.buffer;
            this.buffer = UShortArray.m2440constructorimpl(Arrays.copyOf(sArr, RangesKt.coerceAtLeast(requiredCapacity, UShortArray.m2445getSizeimpl(sArr) * 2)));
        }
    }
