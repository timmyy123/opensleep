...
public final class EnumSerializer<T extends Enum<T>> implements KSerializer<T> {
    ...
    public EnumSerializer(String str, T[] tArr) {
        ...
        tArr.getClass();
        this.values = tArr;
        this.descriptor = LazyKt.lazy(new Url$$ExternalSyntheticLambda1(this, str, 11));
    }
