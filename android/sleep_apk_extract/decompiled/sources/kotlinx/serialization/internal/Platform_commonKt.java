...
public abstract class Platform_commonKt {
    ...
    public static final KClass<Object> kclass(KType kType) {
        ...
        if (!(classifier instanceof KTypeParameter)) {
            Gson$$ExternalSyntheticBUOutline0.m("Only KClass supported as classifier, got ", classifier);
            return null;
        }
    ...
    public static final KType typeOrThrow(KTypeProjection kTypeProjection) {
        ...
        Utf8$$ExternalSyntheticBUOutline0.m$4("Star projections in type arguments are not allowed, but had ", kTypeProjection.getType());
        return null;
    }
