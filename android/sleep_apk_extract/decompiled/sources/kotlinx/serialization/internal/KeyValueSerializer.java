            ...
            while (true) {
                ...
                if (iDecodeElementIndex != -1) {
                    if (iDecodeElementIndex == 0) {
                        ...
                        if (iDecodeElementIndex != 1) {
                            throw new SerializationException(FileInsert$$ExternalSyntheticOutline0.m(iDecodeElementIndex, "Invalid index: "));
                        }
