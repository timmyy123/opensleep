...
public abstract class ViewPager extends ViewGroup {
    ...
    private boolean pageScrolled(int i) {
        if (this.mItems.size() == 0) {
            ...
            Utf8$$ExternalSyntheticBUOutline0.m$3("onPageScrolled did not call superclass implementation");
            return false;
        }
    ...
    public void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        ...
        if (!this.mInLayout) {
            ...
            Utf8$$ExternalSyntheticBUOutline0.m$3("Cannot add pager decor view during layout");
        } else {
    ...
    */
    public void populate(int i) {
        ...
        if (count != this.mExpectedAdapterCount) {
            ...
            Fragment$$ExternalSyntheticOutline1.m(sb, this.mExpectedAdapterCount, ", found: ", count, " Pager id: ");
            sb.append(hexString);
            sb.append(" Pager class: ");
            sb.append(getClass());
            sb.append(" Problematic adapter: ");
            FacebookSdk$$ExternalSyntheticLambda1.m(sb, (Object) this.mAdapter.getClass());
            return;
        }
        int i4 = 0;
        while (true) {
        ...
        if (itemInfoAddNewItem != null) {
            ...
            this.mAdapter.setPrimaryItem(this, this.mCurItem, itemInfoAddNewItem.object);
        }
        this.mAdapter.finishUpdate(this);
        int childCount = getChildCount();
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            ...
            sb.append(" position=");
            return FileInsert$$ExternalSyntheticOutline0.m(this.position, "}", sb);
        }
