...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    private void offsetChildByInset(View view, Rect rect, int i) {
        ...
        if (ViewCompat.isLaidOut(view) && view.getWidth() > 0 && view.getHeight() > 0) {
            ...
            if (behavior == null || !behavior.getInsetDodgeRect(this, view, rectAcquireTempRect)) {
                ...
                Home$$ExternalSyntheticBUOutline0.m$1("Rect should be within the child's bounds. Rect:", rectAcquireTempRect.toShortString(), " | Bounds:", rectAcquireTempRect2.toShortString());
                return;
            }
            releaseTempRect(rectAcquireTempRect2);
    ...
    public static Behavior parseBehavior(Context context, AttributeSet attributeSet, String str) {
        ...
        try {
            ...
            Utf8$$ExternalSyntheticBUOutline0.m("Could not inflate Behavior subclass ".concat(str), (Throwable) e);
            return null;
        }
    }
    ...
    public boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (behavior != null) {
            ...
            if (scrimOpacity > 0.0f) {
                ...
                this.mScrimPaint.setAlpha(clamp(Math.round(scrimOpacity * 255.0f), 0, PHIpAddressSearchManager.END_IP_SCAN));
    ...
    */
    ...
    public void onLayoutChild(View view, int i) {
        ...
        if (layoutParams.checkAnchorChanged()) {
            Utf8$$ExternalSyntheticBUOutline0.m$3("An anchor may not be changed after CoordinatorLayout measurement begins before layout is complete.");
            return;
        }
            ...
            if (view2.getVisibility() == 8) {
                ...
                if (i21 < 0 || mode == 0) {
                    ...
                    if (behavior == null) {
                        ...
                        suggestedMinimumWidth = Math.max(i12, view.getMeasuredWidth() + i17 + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin);
                        int iMax2 = Math.max(i8, view.getMeasuredHeight() + i18 + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin);
                    ...
                    view = view3;
                    suggestedMinimumWidth = Math.max(i12, view.getMeasuredWidth() + i17 + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin);
                    int iMax22 = Math.max(i8, view.getMeasuredHeight() + i18 + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin);
                    iCombineMeasuredStates = View.combineMeasuredStates(i16, view.getMeasuredState());
                ...
                if (z2) {
                    ...
                    view = view32;
                    suggestedMinimumWidth = Math.max(i12, view.getMeasuredWidth() + i17 + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin);
                    int iMax222 = Math.max(i8, view.getMeasuredHeight() + i18 + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin);
                    iCombineMeasuredStates = View.combineMeasuredStates(i16, view.getMeasuredState());
        ...
        private void resolveAnchorView(View view, CoordinatorLayout coordinatorLayout) {
            ...
            if (viewFindViewById == null) {
                if (!coordinatorLayout.isInEditMode()) {
                    Events$$ExternalSyntheticBUOutline0.m("Could not find CoordinatorLayout descendant view with id ", coordinatorLayout.getResources().getResourceName(this.mAnchorId), " to anchor view ", view);
                    return;
                } else {
            ...
            if (viewFindViewById == coordinatorLayout) {
                if (!coordinatorLayout.isInEditMode()) {
                    Utf8$$ExternalSyntheticBUOutline0.m$3("View can not be anchored to the the parent CoordinatorLayout");
                    return;
                } else {
                    this.mAnchorDirectChild = null;
                    this.mAnchorView = null;
            ...
            for (ViewParent parent = viewFindViewById.getParent(); parent != coordinatorLayout && parent != null; parent = parent.getParent()) {
                if (parent == view) {
                    if (!coordinatorLayout.isInEditMode()) {
                        Utf8$$ExternalSyntheticBUOutline0.m$3("Anchor must not be a descendant of the anchored view");
                        return;
                    } else {
                        this.mAnchorDirectChild = null;
                        this.mAnchorView = null;
