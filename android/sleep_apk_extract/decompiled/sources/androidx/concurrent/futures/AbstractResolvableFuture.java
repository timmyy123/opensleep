...
public abstract class AbstractResolvableFuture<V> implements ListenableFuture<V> {
    ...
    public final V get(long j, TimeUnit timeUnit) throws InterruptedException, TimeoutException {
        ...
        StringBuilder sbM = FileInsert$$ExternalSyntheticOutline0.m("Waited ", " ", j);
        ...
        throw new TimeoutException(FileInsert$$ExternalSyntheticOutline0.m$1(string3, " for ", string));
    }
    ...
    public String toString() {
        ...
        if (isCancelled()) {
            ...
            if (strPendingToString != null && !strPendingToString.isEmpty()) {
                Fragment$$ExternalSyntheticOutline1.m67m(sb, "PENDING, info=[", strPendingToString, "]");
            } else if (isDone()) {
                addDoneString(sb);
            } else {
                sb.append("PENDING");
