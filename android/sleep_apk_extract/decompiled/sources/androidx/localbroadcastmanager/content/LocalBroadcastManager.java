...
public final class LocalBroadcastManager {
    ...
    public static final class ReceiverRecord {
        ...
        public String toString() {
            StringBuilder sbM = Fragment$$ExternalSyntheticOutline1.m(128, "Receiver{");
            sbM.append(this.receiver);
            sbM.append(" filter=");
            sbM.append(this.filter);
            if (this.dead) {
                sbM.append(" DEAD");
            }
            sbM.append("}");
                ...
                if (arrayList2 != null) {
                    ...
                    while (i < arrayList2.size()) {
                        ...
                        if (receiverRecord.broadcasting) {
                            ...
                            int iMatch = receiverRecord.filter.match(action, strResolveTypeIfNeeded, scheme, data2, categories, "LocalBroadcastManager");
                            if (iMatch >= 0) {
                                if (z) {
                                ...
                                arrayList = arrayList2;
                                if (z) {
                                    Log.v("LocalBroadcastManager", "  Filter did not match: " + (iMatch != -4 ? iMatch != -3 ? iMatch != -2 ? iMatch != -1 ? "unknown reason" : "type" : "data" : "action" : IntrospectionHelper.AppFunctionSchemaDefinitionAnnotation.PROPERTY_CATEGORY));
                                }
                            }
                        }
                        i++;
