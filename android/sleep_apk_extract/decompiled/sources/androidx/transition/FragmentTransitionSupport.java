...
public class FragmentTransitionSupport extends FragmentTransitionImpl {
    ...
    public Object cloneTransition(Object obj) {
        if (obj != null) {
            return ((Transition) obj).mo191clone();
        }
        return null;
    }
    ...
    public void setListenerForTransitionEnd(Fragment fragment, Object obj, CancellationSignal cancellationSignal, Runnable runnable, final Runnable runnable2) {
        Transition transition = (Transition) obj;
        cancellationSignal.setOnCancelListener(new ListenableFutureKt$$ExternalSyntheticLambda0(runnable, transition, runnable2, 1));
