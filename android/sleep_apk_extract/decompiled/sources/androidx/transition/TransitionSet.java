...
public class TransitionSet extends Transition {
    ...
    public Transition mo191clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo191clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo191clone());
        }
    ...
    public TransitionSet setOrdering(int i) {
        ...
        if (i != 1) {
            throw new AndroidRuntimeException(FileInsert$$ExternalSyntheticOutline0.m(i, "Invalid parameter for TransitionSet ordering: "));
        }
    ...
    public String toString(String str) {
        ...
        for (int i = 0; i < this.mTransitions.size(); i++) {
            ...
            sbM.append(this.mTransitions.get(i).toString(str + "  "));
            string = sbM.toString();
        }
        return string;
    }
