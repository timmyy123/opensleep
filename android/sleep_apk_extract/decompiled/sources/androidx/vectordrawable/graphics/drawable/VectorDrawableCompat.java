...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public static class VPathRenderer {
        ...
        public VPathRenderer(VPathRenderer vPathRenderer) {
            ...
            this.mRootAlpha = PHIpAddressSearchManager.END_IP_SCAN;
            this.mRootName = null;
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int i, int i2, ColorFilter colorFilter) {
            ...
            if (vFullPath.mStrokeColor.willDraw()) {
                ...
                if (complexColorCompat2.isGradient()) {
                    ...
                    paint4.setAlpha(PHIpAddressSearchManager.END_IP_SCAN);
                ...
                if (vObject instanceof VGroup) {
                    ...
                    if (vObject instanceof VFullPath) {
                        ...
                        if (!(vObject instanceof VClipPath)) {
                            Utf8$$ExternalSyntheticBUOutline0.m$3("Unknown object in the tree!");
                            throw null;
                        }
