...
public final class WorkConstraintsTracker {
    ...
    public final boolean areAllConstraintsMet(WorkSpec workSpec) {
        ...
        if (!arrayList.isEmpty()) {
            Logger.get().debug(WorkConstraintsTrackerKt.TAG, "Work " + workSpec.id + " constrained by " + CollectionsKt.joinToString$default(arrayList, null, null, null, new Data$$ExternalSyntheticLambda0(7), 31));
        }
