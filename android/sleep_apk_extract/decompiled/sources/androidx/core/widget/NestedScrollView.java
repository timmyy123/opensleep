...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild2, ScrollingView {
    ...
    */
    ...
    public void addView(View view) {
        if (getChildCount() <= 0) {
            ...
            Utf8$$ExternalSyntheticBUOutline0.m$3("ScrollView can host only one direct child");
        }
    }
    ...
    public float getVerticalScrollFactorCompat() {
        if (this.mVerticalScrollFactor == 0.0f) {
            ...
            if (!context.getTheme().resolveAttribute(R.attr.listPreferredItemHeight, typedValue, true)) {
                Utf8$$ExternalSyntheticBUOutline0.m$3("Expected theme to define listPreferredItemHeight.");
                return 0.0f;
            }
    ...
    */
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        int i = action & PHIpAddressSearchManager.END_IP_SCAN;
        if (i == 0) {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            ...
            return FileInsert$$ExternalSyntheticOutline0.m(this.scrollPosition, "}", sb);
        }
