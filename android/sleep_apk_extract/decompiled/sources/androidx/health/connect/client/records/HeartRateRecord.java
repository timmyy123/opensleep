...
public final class HeartRateRecord implements SeriesRecord<Sample> {
    ...
    @Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0004\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\t\u0018\u00002\u00020\u0001B\u0019\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\b\b\u0001\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0006\u0010\u0007J\u001a\u0010\n\u001a\u00020\t2\b\u0010\b\u001a\u0004\u0018\u00010\u0001H\u0096\u0002¢\u0006\u0004\b\n\u0010\u000bJ\u000f\u0010\r\u001a\u00020\fH\u0016¢\u0006\u0004\b\r\u0010\u000eJ\u000f\u0010\u0010\u001a\u00020\u000fH\u0016¢\u0006\u0004\b\u0010\u0010\u0011R\u0017\u0010\u0003\u001a\u00020\u00028\u0006¢\u0006\f\n\u0004\b\u0003\u0010\u0012\u001a\u0004\b\u0013\u0010\u0014R\u0017\u0010\u0005\u001a\u00020\u00048\u0006¢\u0006\f\n\u0004\b\u0005\u0010\u0015\u001a\u0004\b\u0016\u0010\u0017¨\u0006\u0018"}, d2 = {"Landroidx/health/connect/client/records/HeartRateRecord$Sample;", "", "j$/time/Instant", "time", "", "beatsPerMinute", "<init>", "(Lj$/time/Instant;J)V", "other", "", "equals", "(Ljava/lang/Object;)Z", "", "hashCode", "()I", "", InAppPurchaseConstants.METHOD_TO_STRING, "()Ljava/lang/String;", "Lj$/time/Instant;", "getTime", "()Lj$/time/Instant;", "J", "getBeatsPerMinute", "()J", "connect-client_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
    public static final class Sample {
        private final long beatsPerMinute;
        private final Instant time;

        public Sample(Instant instant, long j) {
            instant.getClass();
            this.time = instant;
            this.beatsPerMinute = j;
            UtilsKt.requireNotLess(Long.valueOf(j), 1L, "beatsPerMinute");
        ...
        public String toString() {
            ...
            return FileInsert$$ExternalSyntheticOutline0.m(sb, this.beatsPerMinute, ')');
        }
    }

    static {
        AggregateMetric.Companion companion = AggregateMetric.INSTANCE;
        BPM_AVG = companion.longMetric$connect_client_release("HeartRateSeries", AggregateMetric.AggregationType.AVERAGE, "bpm");
        BPM_MIN = companion.longMetric$connect_client_release("HeartRateSeries", AggregateMetric.AggregationType.MINIMUM, "bpm");
        BPM_MAX = companion.longMetric$connect_client_release("HeartRateSeries", AggregateMetric.AggregationType.MAXIMUM, "bpm");
        MEASUREMENTS_COUNT = companion.countMetric$connect_client_release("HeartRateSeries");
    }

    public HeartRateRecord(Instant instant, ZoneOffset zoneOffset, Instant instant2, ZoneOffset zoneOffset2, List<Sample> list, androidx.health.connect.client.records.metadata.Metadata metadata) {
        instant.getClass();
        instant2.getClass();
        list.getClass();
        metadata.getClass();
