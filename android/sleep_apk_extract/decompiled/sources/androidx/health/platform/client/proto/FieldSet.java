...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    /* JADX INFO: renamed from: androidx.health.platform.client.proto.FieldSet$1, reason: invalid class name */
    ...
    private void mergeFromField(Map.Entry<T, Object> entry) {
        ...
        if (key.isRepeated()) {
            if (z) {
                Utf8$$ExternalSyntheticBUOutline0.m$3("Lazy fields can not be repeated");
                return;
            }
        ...
        if (key.getLiteJavaType() != WireFormat.JavaType.MESSAGE) {
            if (z) {
                Utf8$$ExternalSyntheticBUOutline0.m$3("Lazy fields must be message-valued");
                return;
            } else {
    ...
    public static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        private static <T extends FieldDescriptorLite<T>> Object replaceBuilders(T t, Object obj, boolean z) {
            ...
            if (!(obj instanceof List)) {
                Home$$ExternalSyntheticBUOutline0.m("Repeated field should contains a List but actually contains type: ", (Object) obj.getClass());
                return null;
            }
        ...
        public int getRepeatedFieldCount(T t) {
            if (!t.isRepeated()) {
                Utf8$$ExternalSyntheticBUOutline0.m$2("getRepeatedFieldCount() can only be called on repeated fields.");
                return 0;
            }
            Object fieldAllowBuilders = getFieldAllowBuilders(t);
            if (fieldAllowBuilders == null) {
