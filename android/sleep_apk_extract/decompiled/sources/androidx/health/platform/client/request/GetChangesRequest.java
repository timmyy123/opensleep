...
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0007\u0018\u0000 \b2\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0001\bB\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005R\u0014\u0010\u0003\u001a\u00020\u0002X\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\t"}, d2 = {"Landroidx/health/platform/client/request/GetChangesRequest;", "Landroidx/health/platform/client/impl/data/ProtoParcelable;", "Landroidx/health/platform/client/proto/RequestProto$GetChangesRequest;", "proto", "<init>", "(Landroidx/health/platform/client/proto/RequestProto$GetChangesRequest;)V", "getProto", "()Landroidx/health/platform/client/proto/RequestProto$GetChangesRequest;", "Companion", "connect-client_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
public final class GetChangesRequest extends ProtoParcelable<RequestProto.GetChangesRequest> {
    ...
    public static final Parcelable.Creator<GetChangesRequest> CREATOR = new Parcelable.Creator<GetChangesRequest>() { // from class: androidx.health.platform.client.request.GetChangesRequest$special$$inlined$newCreator$connect_client_release$1
        ...
        /* JADX WARN: Type inference failed for: r2v7, types: [androidx.health.platform.client.impl.data.ProtoParcelable, androidx.health.platform.client.request.GetChangesRequest] */
        ...
        public GetChangesRequest createFromParcel(Parcel source) {
                ...
                if (i == 1) {
                    return (ProtoParcelable) SharedMemory27Impl.INSTANCE.parseParcelUsingSharedMemory(source, new Function1<byte[], GetChangesRequest>() { // from class: androidx.health.platform.client.request.GetChangesRequest$special$$inlined$newCreator$connect_client_release$1.1
                        ...
                        public final GetChangesRequest invoke(byte[] bArr) {
                            bArr.getClass();
                            RequestProto.GetChangesRequest from = RequestProto.GetChangesRequest.parseFrom(bArr);
                            from.getClass();
                            return new GetChangesRequest(from);
                        }
                    });
                }
            ...
            RequestProto.GetChangesRequest from = RequestProto.GetChangesRequest.parseFrom(bArrCreateByteArray);
            from.getClass();
            return new GetChangesRequest(from);
        }
