...
final class ArrayDecoders {
    ...
    /* JADX INFO: renamed from: androidx.health.platform.client.proto.ArrayDecoders$1, reason: invalid class name */
            ...
            switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[generatedExtension.getLiteType().ordinal()]) {
                ...
                case 17:
                    ...
                    if (generatedExtension.isRepeated()) {
                        int iDecodeGroupField = decodeGroupField(schemaSchemaFor, bArr, i2, i3, i8, registers);
                    ...
                    return mergeGroupField(field, schemaSchemaFor, bArr, i2, i3, i8, registers);
                case 18:
    ...
    public static int decodeVarint32(int i, byte[] bArr, int i2, Registers registers) {
        ...
        byte b2 = bArr[i4];
        if (b2 >= 0) {
            registers.int1 = i5 | (b2 << MqttWireMessage.MESSAGE_TYPE_DISCONNECT);
            return i6;
        }
        int i7 = i5 | ((b2 & 127) << 14);
        int i8 = i2 + 3;
