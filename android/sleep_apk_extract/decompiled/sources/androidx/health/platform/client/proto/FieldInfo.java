...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    /* JADX INFO: renamed from: androidx.health.platform.client.proto.FieldInfo$1, reason: invalid class name */
    ...
    private static void checkFieldNumber(int i) {
        ...
        Utf8$$ExternalSyntheticBUOutline0.m$2(FileInsert$$ExternalSyntheticOutline0.m(i, "fieldNumber must be positive: "));
    }
    ...
    public static FieldInfo forExplicitPresenceField(java.lang.reflect.Field field, int i, FieldType fieldType, java.lang.reflect.Field field2, int i2, boolean z, Internal.EnumVerifier enumVerifier) {
        ...
        Utf8$$ExternalSyntheticBUOutline0.m$2(FileInsert$$ExternalSyntheticOutline0.m(i2, "presenceMask must have exactly one bit set: "));
        return null;
    }
    ...
    public static FieldInfo forField(java.lang.reflect.Field field, int i, FieldType fieldType, boolean z) {
        ...
        Utf8$$ExternalSyntheticBUOutline0.m$3("Shouldn't be called for repeated message fields.");
        return null;
    }
    ...
    public static final class Builder {
        ...
        public Builder withField(java.lang.reflect.Field field) {
            ...
            Utf8$$ExternalSyntheticBUOutline0.m$3("Cannot set field when building a oneof.");
            return null;
        }
        ...
        public Builder withOneof(OneofInfo oneofInfo, Class<?> cls) {
            if (this.field != null || this.presenceField != null) {
                Utf8$$ExternalSyntheticBUOutline0.m$3("Cannot set oneof when field or presenceField have been provided");
                return null;
            }
            this.oneof = oneofInfo;
