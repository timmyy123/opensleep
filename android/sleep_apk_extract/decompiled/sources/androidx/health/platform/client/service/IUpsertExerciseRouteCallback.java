...
public interface IUpsertExerciseRouteCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IUpsertExerciseRouteCallback {
        ...
        public static class Proxy implements IUpsertExerciseRouteCallback {
        ...
        public static IUpsertExerciseRouteCallback asInterface(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IUpsertExerciseRouteCallback)) ? new Proxy(iBinder) : (IUpsertExerciseRouteCallback) iInterfaceQueryLocalInterface;
        }
