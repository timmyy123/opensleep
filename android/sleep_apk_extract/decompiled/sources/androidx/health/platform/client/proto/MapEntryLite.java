...
public class MapEntryLite<K, V> {
    ...
    /* JADX INFO: renamed from: androidx.health.platform.client.proto.MapEntryLite$1, reason: invalid class name */
    ...
    public static <T> T parseField(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite, WireFormat.FieldType fieldType, T t) {
        ...
        Types$$ExternalSyntheticBUOutline0.m$2("Groups are not allowed in maps.");
        return null;
    }
