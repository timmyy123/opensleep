...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    static {
        ...
        UNSIGNED_LEXICOGRAPHICAL_COMPARATOR = new Comparator<ByteString>() { // from class: androidx.health.platform.client.proto.ByteString.2
            /* JADX WARN: Type inference failed for: r0v0, types: [androidx.health.platform.client.proto.ByteString$ByteIterator, java.util.Iterator] */
            /* JADX WARN: Type inference failed for: r3v1, types: [androidx.health.platform.client.proto.ByteString$ByteIterator, java.util.Iterator] */
    ...
    private static int extractHexDigit(String str, int i) {
        ...
        StringBuilder sbM5m = FileInsert$$ExternalSyntheticOutline0.m5m("Invalid hexString ", str, " must only contain [0-9a-fA-F] but contained ");
        sbM5m.append(str.charAt(i));
        sbM5m.append(" at index ");
        sbM5m.append(i);
    ...
    public static ByteString fromHex(String str) {
        if (str.length() % 2 != 0) {
            StringBuilder sbM5m = FileInsert$$ExternalSyntheticOutline0.m5m("Invalid hexString ", str, " of length ");
            sbM5m.append(str.length());
            sbM5m.append(" must be even.");
            throw new NumberFormatException(sbM5m.toString());
        }
    ...
    private String truncateAndEscapeForDisplay() {
        return size() <= 50 ? TextFormatEscaper.escapeBytes(this) : FileInsert$$ExternalSyntheticOutline0.m(new StringBuilder(), TextFormatEscaper.escapeBytes(substring(0, 47)), "...");
    }
    ...
    public final ByteString concat(ByteString byteString) {
        ...
        FacebookSdk$$ExternalSyntheticLambda1.m("ByteString would be too long: ", size(), MqttTopic.SINGLE_LEVEL_WILDCARD, byteString.size());
        return null;
    }
    ...
    public final String toString() {
        ...
        int size = size();
        return FileInsert$$ExternalSyntheticOutline0.m(Fragment$$ExternalSyntheticOutline1.m(size, "<ByteString@", hexString, " size=", " contents=\""), truncateAndEscapeForDisplay(), "\">");
    }
    ...
    public static class LiteralByteString extends LeafByteString {
        ...
        public final boolean equalsRange(ByteString byteString, int i, int i2) {
            if (i2 > byteString.size()) {
                zzbuy$$ExternalSyntheticBUOutline0.m(i2, size());
                return false;
            }
            int i3 = i + i2;
            if (i3 > byteString.size()) {
                StringBuilder sbM = Fragment$$ExternalSyntheticOutline1.m(i, i2, "Ran off end of other: ", ", ", ", ");
