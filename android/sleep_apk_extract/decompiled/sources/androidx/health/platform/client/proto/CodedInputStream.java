...
public abstract class CodedInputStream {
    ...
    public final int setRecursionLimit(int i) {
        if (i < 0) {
            Utf8$$ExternalSyntheticBUOutline0.m$2(FileInsert$$ExternalSyntheticOutline0.m(i, "Recursion limit cannot be negative: "));
            return 0;
        }
    ...
    public final int setSizeLimit(int i) {
        if (i < 0) {
            Utf8$$ExternalSyntheticBUOutline0.m$2(FileInsert$$ExternalSyntheticOutline0.m(i, "Size limit cannot be negative: "));
            return 0;
        }
            ...
            if (this.currentByteBufferLimit != j) {
                ...
                if (this.currentByteBufferLimit - this.currentByteBufferPos >= 10) {
                    ...
                    if (i2 < 0) {
                        ...
                        long j4 = 3 + j;
                        int i3 = (UnsafeUtil.getByte(j3) << MqttWireMessage.MESSAGE_TYPE_DISCONNECT) ^ i2;
                        if (i3 >= 0) {
                            i = i3 ^ 16256;
                        } else {
                            long j5 = 4 + j;
            ...
            if (this.currentByteBufferLimit != j4) {
                ...
                if (this.currentByteBufferLimit - this.currentByteBufferPos >= 10) {
                    ...
                    if (i < 0) {
                        ...
                        long j7 = 3 + j4;
                        int i2 = (UnsafeUtil.getByte(j6) << MqttWireMessage.MESSAGE_TYPE_DISCONNECT) ^ i;
                        if (i2 >= 0) {
                            j = i2 ^ 16256;
                            j6 = j7;
                        } else {
            ...
            if (this.limit != j) {
                ...
                if (this.limit - j2 >= 9) {
                    ...
                    if (i2 < 0) {
                        ...
                        long j4 = 3 + j;
                        int i3 = i2 ^ (UnsafeUtil.getByte(j3) << MqttWireMessage.MESSAGE_TYPE_DISCONNECT);
                        if (i3 >= 0) {
                            i = i3 ^ 16256;
                        } else {
                            j3 = 4 + j;
        ...
        public long readRawVarint64() {
            ...
            if (this.limit != j4) {
                ...
                if (this.limit - j5 >= 9) {
                    ...
                    if (i2 >= 0) {
                        long j7 = 3 + j4;
                        int i3 = i2 ^ (UnsafeUtil.getByte(j6) << MqttWireMessage.MESSAGE_TYPE_DISCONNECT);
                        if (i3 >= 0) {
                            j = i3 ^ 16256;
                            j6 = j7;
                        } else {
