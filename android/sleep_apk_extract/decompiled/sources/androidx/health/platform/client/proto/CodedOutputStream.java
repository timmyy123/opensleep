...
public abstract class CodedOutputStream extends ByteOutput {
        ...
        public final void writeUInt64NoTag(long j) throws OutOfSpaceException {
            ...
            while (true) {
                ...
                if (j3 == 0) {
                    ...
                    int i4 = this.position;
                    this.position = i4 + 1;
                    UnsafeUtil.putByte(bArr2, i4, (byte) ((((int) j) | 128) & PHIpAddressSearchManager.END_IP_SCAN));
                    j >>>= 7;
                }
            }
        }
    ...
    public static final class SafeDirectNioEncoder extends CodedOutputStream {
        ...
        public void writeUInt32NoTag(int i) throws OutOfSpaceException {
            while (true) {
                ...
                try {
                    byteBuffer.put((byte) ((i | 128) & PHIpAddressSearchManager.END_IP_SCAN));
                    i >>>= 7;
                } catch (BufferOverflowException e) {
                    throw new OutOfSpaceException(e);
                }
        ...
        public void writeUInt64NoTag(long j) throws OutOfSpaceException {
            while (true) {
                ...
                try {
                    byteBuffer.put((byte) ((((int) j) | 128) & PHIpAddressSearchManager.END_IP_SCAN));
                    j >>>= 7;
                } catch (BufferOverflowException e) {
                    throw new OutOfSpaceException(e);
                }
            ...
            if (this.position <= this.oneVarintLimit) {
                while (true) {
                    ...
                    if (i2 == 0) {
                        ...
                        this.position = j + 1;
                        UnsafeUtil.putByte(j, (byte) ((i | 128) & PHIpAddressSearchManager.END_IP_SCAN));
                        i >>>= 7;
                    }
                }
            } else {
                while (true) {
                    ...
                    if ((i & (-128)) == 0) {
                        ...
                        this.position = j2 + 1;
                        UnsafeUtil.putByte(j2, (byte) ((i | 128) & PHIpAddressSearchManager.END_IP_SCAN));
                        i >>>= 7;
                    }
                }
            }
            ...
            if (this.position <= this.oneVarintLimit) {
                while (true) {
                    ...
                    if (j2 == 0) {
                        ...
                        this.position = j3 + 1;
                        UnsafeUtil.putByte(j3, (byte) ((((int) j) | 128) & PHIpAddressSearchManager.END_IP_SCAN));
                        j >>>= 7;
                    }
                }
            } else {
                while (true) {
                    ...
                    if ((j & (-128)) == 0) {
                        ...
                        this.position = j4 + 1;
                        UnsafeUtil.putByte(j4, (byte) ((((int) j) | 128) & PHIpAddressSearchManager.END_IP_SCAN));
                        j >>>= 7;
                    }
                }
            }
    ...
    public static class OutOfSpaceException extends IOException {
        ...
        public OutOfSpaceException(String str) {
            super(FileInsert$$ExternalSyntheticOutline0.m("CodedOutputStream was writing to a flat byte array and ran out of space.: ", str));
        }
    ...
    public static CodedOutputStream newInstance(ByteOutput byteOutput, int i) {
        ...
        Utf8$$ExternalSyntheticBUOutline0.m$2("bufferSize must be positive");
        return null;
    }
}
