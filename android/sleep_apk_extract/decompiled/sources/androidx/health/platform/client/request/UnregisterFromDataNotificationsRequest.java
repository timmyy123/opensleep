...
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0007\u0018\u0000 \b2\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0001\bB\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005R\u0014\u0010\u0003\u001a\u00020\u0002X\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\t"}, d2 = {"Landroidx/health/platform/client/request/UnregisterFromDataNotificationsRequest;", "Landroidx/health/platform/client/impl/data/ProtoParcelable;", "Landroidx/health/platform/client/proto/RequestProto$UnregisterFromDataNotificationsRequest;", "proto", "<init>", "(Landroidx/health/platform/client/proto/RequestProto$UnregisterFromDataNotificationsRequest;)V", "getProto", "()Landroidx/health/platform/client/proto/RequestProto$UnregisterFromDataNotificationsRequest;", "Companion", "connect-client_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
public final class UnregisterFromDataNotificationsRequest extends ProtoParcelable<RequestProto.UnregisterFromDataNotificationsRequest> {
    ...
    public static final Parcelable.Creator<UnregisterFromDataNotificationsRequest> CREATOR = new Parcelable.Creator<UnregisterFromDataNotificationsRequest>() { // from class: androidx.health.platform.client.request.UnregisterFromDataNotificationsRequest$special$$inlined$newCreator$connect_client_release$1
        /* JADX WARN: Can't rename method to resolve collision */
        /* JADX WARN: Type inference failed for: r2v7, types: [androidx.health.platform.client.impl.data.ProtoParcelable, androidx.health.platform.client.request.UnregisterFromDataNotificationsRequest] */
                ...
                if (i == 1) {
                    return (ProtoParcelable) SharedMemory27Impl.INSTANCE.parseParcelUsingSharedMemory(source, new Function1<byte[], UnregisterFromDataNotificationsRequest>() { // from class: androidx.health.platform.client.request.UnregisterFromDataNotificationsRequest$special$$inlined$newCreator$connect_client_release$1.1
                        ...
                        public final UnregisterFromDataNotificationsRequest invoke(byte[] bArr) {
                            bArr.getClass();
                            RequestProto.UnregisterFromDataNotificationsRequest from = RequestProto.UnregisterFromDataNotificationsRequest.parseFrom(bArr);
                            from.getClass();
    ...
    public UnregisterFromDataNotificationsRequest(RequestProto.UnregisterFromDataNotificationsRequest unregisterFromDataNotificationsRequest) {
        unregisterFromDataNotificationsRequest.getClass();
        this.proto = unregisterFromDataNotificationsRequest;
    }
