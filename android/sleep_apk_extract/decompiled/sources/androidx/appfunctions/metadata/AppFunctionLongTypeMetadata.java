...
public final class AppFunctionLongTypeMetadata extends AppFunctionDataTypeMetadata {
    ...
    public AppFunctionDataTypeMetadataDocument toAppFunctionDataTypeMetadataDocument$appfunctions() {
        ...
        return new AppFunctionDataTypeMetadataDocument(null, null, 6, null, null, null, null, null, null, isNullable, null, description, null, 5627, null);
    }

    @Override // androidx.appfunctions.metadata.AppFunctionDataTypeMetadata
    public String toString() {
        return "AppFunctionLongTypeMetadata(isNullable=" + getIsNullable() + ", description=" + getDescription() + ')';
    }
    ...
    public AppFunctionLongTypeMetadata(boolean z) {
