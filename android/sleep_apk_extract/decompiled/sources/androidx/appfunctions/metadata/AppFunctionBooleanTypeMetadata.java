...
public final class AppFunctionBooleanTypeMetadata extends AppFunctionDataTypeMetadata {
    ...
    public AppFunctionDataTypeMetadataDocument toAppFunctionDataTypeMetadataDocument$appfunctions() {
        ...
        return new AppFunctionDataTypeMetadataDocument(null, null, 1, null, null, null, null, null, null, isNullable, null, description, null, 5627, null);
    }

    @Override // androidx.appfunctions.metadata.AppFunctionDataTypeMetadata
    public String toString() {
        return "AppFunctionBooleanTypeMetadata(isNullable=" + getIsNullable() + ", description=" + getDescription() + ')';
    }
    ...
    public AppFunctionBooleanTypeMetadata(boolean z) {
