...
public final class AppFunctionIntTypeMetadata extends AppFunctionDataTypeMetadata {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof AppFunctionIntTypeMetadata) && super.equals(other) && Intrinsics.areEqual(this.enumValues, ((AppFunctionIntTypeMetadata) other).enumValues);
    }
    ...
    @Override // androidx.appfunctions.metadata.AppFunctionDataTypeMetadata
    public int hashCode() {
        return Objects.hash(Boolean.valueOf(getIsNullable()), getDescription(), this.enumValues);
    }
    ...
    public AppFunctionDataTypeMetadataDocument toAppFunctionDataTypeMetadataDocument$appfunctions() {
        ...
        return new AppFunctionDataTypeMetadataDocument(null, null, 7, null, null, null, null, null, null, isNullable, null, description, null, 5627, null);
    }

    @Override // androidx.appfunctions.metadata.AppFunctionDataTypeMetadata
    public String toString() {
        return "AppFunctionIntTypeMetadata(isNullable=" + getIsNullable() + ", description=" + getDescription() + ", enumValues=" + this.enumValues + ')';
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public AppFunctionIntTypeMetadata(boolean z, String str) {
        this(z, str, null, 4, null);
        str.getClass();
    }

    public AppFunctionIntTypeMetadata(boolean z) {
