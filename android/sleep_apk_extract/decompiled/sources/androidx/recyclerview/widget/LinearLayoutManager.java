...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public static class AnchorInfo {
        ...
        public String toString() {
            ...
            sb.append(", mValid=");
            return Fragment$$ExternalSyntheticOutline1.m(sb, this.mValid, '}');
        }
    }
        ...
        if (!state.isPreLayout() && (i = this.mPendingScrollPosition) != -1) {
            if (i >= 0 && i < state.getItemCount()) {
                ...
                if (viewFindViewByPosition == null) {
                    ...
                    anchorInfo.mCoordinate = z3 ? this.mOrientationHelper.getTotalSpaceChange() + orientationHelper4.getDecoratedEnd(viewFindViewByPosition) : orientationHelper4.getDecoratedStart(viewFindViewByPosition);
                }
                return true;
            }
            this.mPendingScrollPosition = -1;
    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        ...
        if (this.mOrientation == 1) {
            ...
            if (i4 != -1) {
                ...
                i = layoutChunkResult.mConsumed + i5;
                linearLayoutManager = this;
                i3 = i5;
                linearLayoutManager.layoutDecoratedWithMargins(next, paddingLeft, i3, i2, i);
