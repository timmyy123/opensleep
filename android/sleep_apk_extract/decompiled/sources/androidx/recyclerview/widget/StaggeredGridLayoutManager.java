...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private boolean checkSpanForGap(Span span) {
        ...
        if (span.getEndLine() < this.mPrimaryOrientation.getEndAfterPadding()) {
            z = span.getLayoutParams(span.mViews.get(r2.size() - 1)).mFullSpan;
            return !z;
        }
        return false;
    }
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (layoutState.hasMore(state) && (r02.mLayoutState.mInfinite || !r02.mRemainingSpans.isEmpty())) {
            ...
            if (i2 == 1) {
                decoratedMeasurement = z3 ? r02.getMaxEnd(endAfterPadding) : span2.getEndLine(endAfterPadding);
                ...
                minStart = z3 ? r02.getMinStart(endAfterPadding) : span2.getStartLine(endAfterPadding);
            ...
            if (r02.isLayoutRTL() && r02.mOrientation == 1) {
                ...
                decoratedMeasurement2 = z4 ? orientationHelper2.getEndAfterPadding() : orientationHelper2.getEndAfterPadding() - (((r02.mSpanCount - 1) - span2.mIndex) * r02.mSizePerSpan);
                startAfterPadding = decoratedMeasurement2 - r02.mSecondaryOrientation.getDecoratedMeasurement(next);
            } else {
                startAfterPadding = layoutParams.mFullSpan ? r02.mSecondaryOrientation.getStartAfterPadding() : r02.mSecondaryOrientation.getStartAfterPadding() + (span2.mIndex * r02.mSizePerSpan);
            ...
            if (r02.mOrientation == 1) {
                r02.layoutDecoratedWithMargins(next, i4, decoratedMeasurement, i3, minStart);
                r0 = this;
            } else {
                r02.layoutDecoratedWithMargins(next, decoratedMeasurement, i4, minStart, i3);
                r0 = r02;
            }
        ...
        int i5 = r02.mLayoutState.mLayoutDirection;
        OrientationHelper orientationHelper3 = r02.mPrimaryOrientation;
        int startAfterPadding2 = i5 == -1 ? r02.mPrimaryOrientation.getStartAfterPadding() - r02.getMinStart(orientationHelper3.getStartAfterPadding()) : r02.getMaxEnd(orientationHelper3.getEndAfterPadding()) - r02.mPrimaryOrientation.getEndAfterPadding();
    ...
    */
    ...
    public Parcelable onSaveInstanceState() {
        ...
        for (int i2 = 0; i2 < this.mSpanCount; i2++) {
            ...
            Span[] spanArr = this.mSpans;
            if (z) {
                startLine = spanArr[i2].getEndLine(Integer.MIN_VALUE);
                if (startLine != Integer.MIN_VALUE) {
                    startAfterPadding = this.mPrimaryOrientation.getEndAfterPadding();
                    startLine -= startAfterPadding;
                }
            } else {
                startLine = spanArr[i2].getStartLine(Integer.MIN_VALUE);
                if (startLine != Integer.MIN_VALUE) {
    ...
    public void setOrientation(int i) {
        if (i != 0 && i != 1) {
            Utf8$$ExternalSyntheticBUOutline0.m$2("invalid orientation.");
            return;
        }
