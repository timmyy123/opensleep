    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        if (i10 <= 0 || j2 == 0 || (i10 >= i14 - 1 && !z9 && iMax2 <= 1)) {
            ...
            if (z9) {
                ...
                if ((j2 & ((long) (1 << i28))) != 0 && !((LayoutParams) getChildAt(i28).getLayoutParams()).preventEdgeOffset) {
                    fBitCount -= 0.5f;
                }
            }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i17 = 0; i17 < childCount; i17++) {
            ...
            if (childAt4.getVisibility() != 8 && !layoutParams3.isOverflowButton) {
                ...
                paddingLeft2 = FileInsert$$ExternalSyntheticOutline0.m(measuredWidth4, ((LinearLayout.LayoutParams) layoutParams3).rightMargin, iMax, i18);
            }
        }
    }
