...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public String getShortcutLabel() {
        ...
        appendModifier(sb, i, NativeProtocol.MESSAGE_GET_ACCESS_TOKEN_REQUEST, resources.getString(R$string.abc_menu_meta_shortcut_label));
    ...
    public void setShowAsAction(int i) {
        int i2 = i & 3;
        if (i2 != 0 && i2 != 1 && i2 != 2) {
            Utf8$$ExternalSyntheticBUOutline0.m$2("SHOW_AS_ACTION_ALWAYS, SHOW_AS_ACTION_IF_ROOM, and SHOW_AS_ACTION_NEVER are mutually exclusive.");
        } else {
