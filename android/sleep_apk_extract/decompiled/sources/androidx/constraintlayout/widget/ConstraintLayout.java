    ...
    public class Measurer implements BasicMeasure.Measurer {
        ...
        public final void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
            ...
            if (i6 == 1) {
                ...
                iMakeMeasureSpec = ViewGroup.getChildMeasureSpec(this.mLayoutWidthSpec, constraintWidget.getHorizontalMargin() + i5, -1);
            } else if (i6 != 4) {
                iMakeMeasureSpec = 0;
            } else {
                iMakeMeasureSpec = ViewGroup.getChildMeasureSpec(this.mLayoutWidthSpec, i5, -2);
            ...
            if (i8 == 1) {
                ...
                iMakeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.mLayoutHeightSpec, constraintWidget.getVerticalMargin() + i4, -1);
            } else if (i8 != 4) {
                iMakeMeasureSpec2 = 0;
            } else {
                iMakeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.mLayoutHeightSpec, i4, -2);
    ...
    */
    ...
    public boolean dynamicUpdateConstraints(int i, int i2) {
        ...
        if (this.mModifiers != null) {
            ...
            Iterator<Object> it2 = this.mModifiers.iterator();
            do {
                if (it2.hasNext()) {
                    if (it2.next() == null) {
                        it = this.mLayoutWidget.getChildren().iterator();
                    } else {
