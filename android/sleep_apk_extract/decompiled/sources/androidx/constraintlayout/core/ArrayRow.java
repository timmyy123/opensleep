...
public class ArrayRow implements LinearSystem.Row {
    ...
    */
    public String toReadableString() {
        boolean z;
        String strConcat = (this.mVariable == null ? AppEventsConstants.EVENT_PARAM_VALUE_NO : "" + this.mVariable).concat(" = ");
        if (this.mConstantValue != 0.0f) {
            StringBuilder sbM = FileInsert$$ExternalSyntheticOutline0.m(strConcat);
        ...
        for (int i = 0; i < currentSize; i++) {
            ...
            if (variable != null) {
                ...
                if (variableValue != 0.0f) {
                    ...
                    if (!z) {
                        if (variableValue < 0.0f) {
                            strConcat = FileInsert$$ExternalSyntheticOutline0.m$1(strConcat, "- ");
                            variableValue *= -1.0f;
                        }
                        strConcat = variableValue == 1.0f ? FileInsert$$ExternalSyntheticOutline0.m$1(strConcat, string) : strConcat + variableValue + " " + string;
                        z = true;
        ...
        return !z ? FileInsert$$ExternalSyntheticOutline0.m$1(strConcat, "0.0") : strConcat;
    }
