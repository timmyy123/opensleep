...
public class ArrayLinkedVariables implements ArrayRow.ArrayRowVariables {
    ...
    public String toString() {
        ...
        String string = "";
        for (int i2 = 0; i != -1 && i2 < this.mCurrentSize; i2++) {
            StringBuilder sbM = FileInsert$$ExternalSyntheticOutline0.m(string.concat(" -> "));
            sbM.append(this.mArrayValues[i]);
            sbM.append(" : ");
            StringBuilder sbM2 = FileInsert$$ExternalSyntheticOutline0.m(sbM.toString());
            sbM2.append(this.mCache.mIndexedVariables[this.mArrayIndices[i]]);
