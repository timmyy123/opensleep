...
public abstract class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public static Fragment instantiate(Context context, String str, Bundle bundle) {
        try {
            ...
            throw new InstantiationException(FileInsert$$ExternalSyntheticOutline0.m("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e);
        } catch (java.lang.InstantiationException e2) {
            throw new InstantiationException(FileInsert$$ExternalSyntheticOutline0.m("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e2);
        } catch (NoSuchMethodException e3) {
            throw new InstantiationException(FileInsert$$ExternalSyntheticOutline0.m("Unable to instantiate fragment ", str, ": could not find Fragment constructor"), e3);
        } catch (InvocationTargetException e4) {
            throw new InstantiationException(FileInsert$$ExternalSyntheticOutline0.m("Unable to instantiate fragment ", str, ": calling Fragment constructor caused an exception"), e4);
        }
    }
    ...
    private <I, O> ActivityResultLauncher<I> prepareCallInternal(final ActivityResultContract<I, O> activityResultContract, final Function<Void, ActivityResultRegistry> function, final ActivityResultCallback<O> activityResultCallback) {
        if (this.mState > 1) {
            Utf8$$ExternalSyntheticBUOutline0.m$3(Fragment$$ExternalSyntheticOutline1.m("Fragment ", this, " is attempting to registerForActivityResult after being created. Fragments must call registerForActivityResult() before they are created (i.e. initialization, onAttach(), or onCreate())."));
            return null;
        }
        ...
        return new ActivityResultLauncher<I>() { // from class: androidx.fragment.app.Fragment.10
            ...
            public void launch(I i, ActivityOptionsCompat activityOptionsCompat) {
                ...
                if (activityResultLauncher != null) {
                    ...
                    Utf8$$ExternalSyntheticBUOutline0.m$3("Operation cannot be started before fragment is in created state");
                }
            }
    ...
    public FragmentContainer createFragmentContainer() {
        return new FragmentContainer() { // from class: androidx.fragment.app.Fragment.5
            ...
            public View onFindViewById(int i) {
                ...
                Fragment$$ExternalSyntheticBUOutline0.m$1("Fragment ", Fragment.this, " does not have a view");
                return null;
            }
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        this.mChildFragmentManager.dump(FileInsert$$ExternalSyntheticOutline0.m$1(str, "  "), fileDescriptor, printWriter, strArr);
    }
    ...
    public final FragmentManager getChildFragmentManager() {
        ...
        Utf8$$ExternalSyntheticBUOutline0.m$3(Fragment$$ExternalSyntheticOutline1.m("Fragment ", this, " has not been attached yet."));
        return null;
    }
    ...
    public ViewModelProvider.Factory getDefaultViewModelProviderFactory() {
        ...
        if (this.mFragmentManager == null) {
            Utf8$$ExternalSyntheticBUOutline0.m$3("Can't access ViewModels from detached fragment");
            return null;
        }
    ...
    public LayoutInflater getLayoutInflater(Bundle bundle) {
        FragmentHostCallback<?> fragmentHostCallback = this.mHost;
        if (fragmentHostCallback == null) {
            Utf8$$ExternalSyntheticBUOutline0.m$3("onGetLayoutInflater() cannot be executed until the Fragment is attached to the FragmentManager.");
            return null;
        }
    ...
    public final FragmentManager getParentFragmentManager() {
        ...
        Utf8$$ExternalSyntheticBUOutline0.m$3(Fragment$$ExternalSyntheticOutline1.m("Fragment ", this, " not associated with a fragment manager."));
        return null;
    }
    ...
    public LifecycleOwner getViewLifecycleOwner() {
        ...
        Utf8$$ExternalSyntheticBUOutline0.m$3("Can't access the Fragment View's LifecycleOwner when getView() is null i.e., before onCreateView() or after onDestroyView()");
        return null;
    }
    ...
    public ViewModelStore getViewModelStore() {
        ...
        Utf8$$ExternalSyntheticBUOutline0.m$3("Calling getViewModelStore() before a Fragment reaches onCreate() when using setMaxLifecycle(INITIALIZED) is not supported");
        return null;
    }
    ...
    public void performActivityCreated(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(Fragment$$ExternalSyntheticOutline1.m("Fragment ", this, " did not call through to super.onActivityCreated()"));
        }
        restoreViewState();
    ...
    public void performAttach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(Fragment$$ExternalSyntheticOutline1.m("Fragment ", this, " did not call through to super.onAttach()"));
        }
    ...
    public void performCreate(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(Fragment$$ExternalSyntheticOutline1.m("Fragment ", this, " did not call through to super.onCreate()"));
        }
    ...
    public void performCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (viewOnCreateView == null) {
            if (fragmentViewLifecycleOwner.isInitialized()) {
                Utf8$$ExternalSyntheticBUOutline0.m$3("Called getViewLifecycleOwner() but onCreateView() returned null");
                return;
            } else {
        ...
        AbstractC0110ViewTreeLifecycleOwner.set(this.mView, this.mViewLifecycleOwner);
        AbstractC0111ViewTreeViewModelStoreOwner.set(this.mView, this.mViewLifecycleOwner);
        AbstractC0122ViewTreeSavedStateRegistryOwner.set(this.mView, this.mViewLifecycleOwner);
    ...
    public void performDestroy() {
        ...
        onDestroy();
        if (!this.mCalled) {
            throw new SuperNotCalledException(Fragment$$ExternalSyntheticOutline1.m("Fragment ", this, " did not call through to super.onDestroy()"));
        }
    }
    ...
    public void performDestroyView() {
        ...
        onDestroyView();
        if (!this.mCalled) {
            throw new SuperNotCalledException(Fragment$$ExternalSyntheticOutline1.m("Fragment ", this, " did not call through to super.onDestroyView()"));
        }
    ...
    public void performDetach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(Fragment$$ExternalSyntheticOutline1.m("Fragment ", this, " did not call through to super.onDetach()"));
        }
    ...
    public void performPause() {
        ...
        onPause();
        if (!this.mCalled) {
            throw new SuperNotCalledException(Fragment$$ExternalSyntheticOutline1.m("Fragment ", this, " did not call through to super.onPause()"));
        }
    }
    ...
    public void performResume() {
        ...
        onResume();
        if (!this.mCalled) {
            throw new SuperNotCalledException(Fragment$$ExternalSyntheticOutline1.m("Fragment ", this, " did not call through to super.onResume()"));
        }
    ...
    public void performStart() {
        ...
        onStart();
        if (!this.mCalled) {
            throw new SuperNotCalledException(Fragment$$ExternalSyntheticOutline1.m("Fragment ", this, " did not call through to super.onStart()"));
        }
        LifecycleRegistry lifecycleRegistry = this.mLifecycleRegistry;
    ...
    public void performStop() {
        ...
        onStop();
        if (!this.mCalled) {
            throw new SuperNotCalledException(Fragment$$ExternalSyntheticOutline1.m("Fragment ", this, " did not call through to super.onStop()"));
        }
    }
    ...
    public final void requestPermissions(String[] strArr, int i) {
        if (this.mHost != null) {
            ...
            Utf8$$ExternalSyntheticBUOutline0.m$3(Fragment$$ExternalSyntheticOutline1.m("Fragment ", this, " not attached to Activity"));
        }
    }
    ...
    public final FragmentActivity requireActivity() {
        ...
        Utf8$$ExternalSyntheticBUOutline0.m$3(Fragment$$ExternalSyntheticOutline1.m("Fragment ", this, " not attached to an activity."));
        return null;
    }
    ...
    public final Bundle requireArguments() {
        ...
        Utf8$$ExternalSyntheticBUOutline0.m$3(Fragment$$ExternalSyntheticOutline1.m("Fragment ", this, " does not have any arguments."));
        return null;
    }
    ...
    public final Context requireContext() {
        ...
        Utf8$$ExternalSyntheticBUOutline0.m$3(Fragment$$ExternalSyntheticOutline1.m("Fragment ", this, " not attached to a context."));
        return null;
    }
    ...
    public final Object requireHost() {
        ...
        Utf8$$ExternalSyntheticBUOutline0.m$3(Fragment$$ExternalSyntheticOutline1.m("Fragment ", this, " not attached to a host."));
        return null;
    }
    ...
    public final Fragment requireParentFragment() {
        ...
        if (getContext() == null) {
            Utf8$$ExternalSyntheticBUOutline0.m$3(Fragment$$ExternalSyntheticOutline1.m("Fragment ", this, " is not attached to any Fragment or host"));
            return null;
        }
    ...
    public final View requireView() {
        ...
        Utf8$$ExternalSyntheticBUOutline0.m$3(Fragment$$ExternalSyntheticOutline1.m("Fragment ", this, " did not return a View from onCreateView() or this was called before onCreateView()."));
        return null;
    }
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(Fragment$$ExternalSyntheticOutline1.m("Fragment ", this, " did not call through to super.onViewStateRestored()"));
        }
        if (this.mView != null) {
    ...
    public void setArguments(Bundle bundle) {
        if (this.mFragmentManager == null || !isStateSaved()) {
            ...
            Utf8$$ExternalSyntheticBUOutline0.m$3("Fragment already added and state has been saved");
        }
    }
    ...
    public void setInitialSavedState(SavedState savedState) {
        Bundle bundle;
        if (this.mFragmentManager != null) {
            Utf8$$ExternalSyntheticBUOutline0.m$3("Fragment already added");
            return;
        }
    ...
    public void setTargetFragment(Fragment fragment, int i) {
        ...
        if (fragmentManager != null && fragmentManager2 != null && fragmentManager != fragmentManager2) {
            Utf8$$ExternalSyntheticBUOutline0.m$2(Fragment$$ExternalSyntheticOutline1.m("Fragment ", fragment, " must share the same FragmentManager to be set as a target fragment"));
            return;
        }
        for (Fragment targetFragment = fragment; targetFragment != null; targetFragment = targetFragment.getTargetFragment(false)) {
            if (targetFragment.equals(this)) {
                Fragment$$ExternalSyntheticBUOutline0.m(fragment, " as the target of ", this, " would create a target cycle", "Setting ");
                return;
            }
        }
        if (fragment == null) {
