...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    private Observer<LifecycleOwner> mObserver = new Observer<LifecycleOwner>() { // from class: androidx.fragment.app.DialogFragment.4
        ...
        public void onChanged(LifecycleOwner lifecycleOwner) {
            ...
            if (viewRequireView.getParent() != null) {
                Utf8$$ExternalSyntheticBUOutline0.m$3("DialogFragment can not be attached to a container view");
                return;
            }
            if (DialogFragment.this.mDialog != null) {
    ...
    public void onStart() {
        ...
        if (dialog != null) {
            ...
            AbstractC0111ViewTreeViewModelStoreOwner.set(decorView, this);
            AbstractC0122ViewTreeSavedStateRegistryOwner.set(decorView, this);
        }
    }
    ...
    public final Dialog requireDialog() {
        ...
        Fragment$$ExternalSyntheticBUOutline0.m("DialogFragment ", this, " does not have a Dialog.");
        return null;
    }
