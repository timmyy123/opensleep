    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (method == Client.Method.GET_SYNC) {
            ...
            if (coapResponse != null) {
                ...
                try {
                    objFromJson = Client.INSTANCE.getGson().fromJson(responseText, (Class<Object>) AuthenticationResult.class);
        ...
        CoapHandler coapHandler = new CoapHandler() { // from class: com.urbandroid.smartlight.ikea.tradfri.Client$Plain$authenticate$$inlined$send$default$1.1
            ...
            public void onLoad(CoapResponse response) {
                ...
                try {
                    Object objFromJson2 = Client.INSTANCE.getGson().fromJson(responseText2, (Class<Object>) AuthenticationResult.class);
