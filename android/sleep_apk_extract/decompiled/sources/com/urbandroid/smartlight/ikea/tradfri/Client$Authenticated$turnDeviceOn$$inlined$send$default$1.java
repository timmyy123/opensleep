...
public final class Client$Authenticated$turnDeviceOn$$inlined$send$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Object>, Object> {
    ...
    public Client$Authenticated$turnDeviceOn$$inlined$send$default$1(Client client, Client.Method method, String str, String str2, String str3, long j, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new Client$Authenticated$turnDeviceOn$$inlined$send$default$1(this.this$0, this.$method, this.$path, this.$payload, this.$action, this.$timeoutInMs, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Object> continuation) {
        return ((Client$Authenticated$turnDeviceOn$$inlined$send$default$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        CoapHandler coapHandler = new CoapHandler() { // from class: com.urbandroid.smartlight.ikea.tradfri.Client$Authenticated$turnDeviceOn$$inlined$send$default$1.1
