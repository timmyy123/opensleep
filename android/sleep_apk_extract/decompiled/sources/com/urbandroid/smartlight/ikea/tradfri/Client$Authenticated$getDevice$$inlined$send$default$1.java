...
public final class Client$Authenticated$getDevice$$inlined$send$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Device>, Object> {
    ...
    public Client$Authenticated$getDevice$$inlined$send$default$1(Client client, Client.Method method, String str, String str2, String str3, long j, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new Client$Authenticated$getDevice$$inlined$send$default$1(this.this$0, this.$method, this.$path, this.$payload, this.$action, this.$timeoutInMs, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Device> continuation) {
        return ((Client$Authenticated$getDevice$$inlined$send$default$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (method == Client.Method.GET_SYNC) {
            ...
            if (coapResponse != null) {
                ...
                try {
                    objFromJson = Client.INSTANCE.getGson().fromJson(responseText, (Class<Object>) Device.class);
        ...
        CoapHandler coapHandler = new CoapHandler() { // from class: com.urbandroid.smartlight.ikea.tradfri.Client$Authenticated$getDevice$$inlined$send$default$1.1
            ...
            public void onLoad(CoapResponse response) {
                ...
                try {
                    Object objFromJson2 = Client.INSTANCE.getGson().fromJson(responseText2, (Class<Object>) Device.class);
