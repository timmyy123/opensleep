...
public final class Client$Authenticated$special$$inlined$CoroutineExceptionHandler$1 extends AbstractCoroutineContextElement implements CoroutineExceptionHandler {
    ...
    public Client$Authenticated$special$$inlined$CoroutineExceptionHandler$1(CoroutineExceptionHandler.Companion companion, Client.Authenticated authenticated) {
        super(companion);
    ...
    public void handleException(CoroutineContext context, Throwable exception) {
        ...
        String str = "failure " + exception + " handled !";
        Logger.logSevere(Logger.defaultTag, authenticated.getTag() + ": " + ((Object) str), null);
    }
}
