...
public final class TradfriDiscovery$special$$inlined$CoroutineExceptionHandler$1 extends AbstractCoroutineContextElement implements CoroutineExceptionHandler {
    ...
    public TradfriDiscovery$special$$inlined$CoroutineExceptionHandler$1(CoroutineExceptionHandler.Companion companion, TradfriDiscovery tradfriDiscovery) {
        super(companion);
    ...
    public void handleException(CoroutineContext context, Throwable exception) {
        Toast.makeText(this.this$0.getContext(), "ikea-tradfri: failure", 1).show();
        TradfriDiscovery tradfriDiscovery = this.this$0;
        Logger.logSevere(Logger.defaultTag, tradfriDiscovery.getTag() + ": Uncaught failure:", exception);
    }
}
