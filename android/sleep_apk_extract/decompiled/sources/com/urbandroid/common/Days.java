...
public final class Days implements TimeType {
    ...
    public static final /* synthetic */ Days m956boximpl(long j) {
        return new Days(j);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m957constructorimpl(long j) {
        return j;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m958equalsimpl(long j, Object obj) {
        return (obj instanceof Days) && j == ((Days) obj).m963unboximpl();
    }

    /* JADX INFO: renamed from: getMillis-impl, reason: not valid java name */
    public static long m959getMillisimpl(long j) {
        return m956boximpl(j).getMillis();
    }

    /* JADX INFO: renamed from: getUnit-impl, reason: not valid java name */
    public static TimeUnit m960getUnitimpl(long j) {
        return TimeUnit.DAYS;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m961hashCodeimpl(long j) {
    ...
    public TimeUnit getUnit() {
        return m960getUnitimpl(this.value);
    }
