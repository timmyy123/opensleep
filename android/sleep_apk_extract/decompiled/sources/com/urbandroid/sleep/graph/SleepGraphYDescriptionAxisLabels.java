...
public class SleepGraphYDescriptionAxisLabels implements IAxisLabels<Float> {
    ...
    public String getLabelAt(AxisBoundaries<Float> axisBoundaries, Float f) {
        return f.floatValue() == 0.25f ? this.context.getString(R.string.label_deep_sleep) : f.floatValue() == 0.5f ? this.context.getString(R.string.rem) : f.floatValue() == 0.75f ? this.context.getString(R.string.label_light_sleep) : f.floatValue() == 1.0f ? this.context.getString(R.string.awake) : "";
    }
