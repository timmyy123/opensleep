...
@DebugMetadata(c = "com.urbandroid.sleep.trial.Billing$refreshPurchaseState$2$1$result$1", f = "Billing.kt", l = {701}, m = "invokeSuspend", v = 2)
public final class Billing$refreshPurchaseState$2$1$result$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super PurchasesResult>, Object> {
    final /* synthetic */ String $type;
    int label;
    final /* synthetic */ Billing this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Billing$refreshPurchaseState$2$1$result$1(Billing billing, String str, Continuation<? super Billing$refreshPurchaseState$2$1$result$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new Billing$refreshPurchaseState$2$1$result$1(this.this$0, this.$type, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super PurchasesResult> continuation) {
        return ((Billing$refreshPurchaseState$2$1$result$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
