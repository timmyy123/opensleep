...
public final class AutomationService$special$$inlined$CoroutineExceptionHandler$1 extends AbstractCoroutineContextElement implements CoroutineExceptionHandler {
    ...
    public AutomationService$special$$inlined$CoroutineExceptionHandler$1(CoroutineExceptionHandler.Companion companion, AutomationService automationService) {
        super(companion);
    ...
    public void handleException(CoroutineContext context, Throwable exception) {
        ...
        Logger.logSevere(Logger.defaultTag, automationService.getTag() + ": failure", exception);
