...
public final class IftttActivity$special$$inlined$CoroutineExceptionHandler$1 extends AbstractCoroutineContextElement implements CoroutineExceptionHandler {
    final /* synthetic */ IftttActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public IftttActivity$special$$inlined$CoroutineExceptionHandler$1(CoroutineExceptionHandler.Companion companion, IftttActivity iftttActivity) {
        super(companion);
    ...
    public void handleException(CoroutineContext context, Throwable exception) {
        ...
        Toast.makeText(iftttActivity, iftttActivity.getTag() + ": failure", 1).show();
