...
public abstract class MenuDrawerItem extends IMenuDrawerItem<ViewHolder> {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MenuDrawerItem(Context context, String str, int i) {
        super(context, com.urbandroid.sleep.R.layout.menu_drawer_item, IMenuDrawerItem.Type.ITEM);
        context.getClass();
        str.getClass();
        this.text = str;
        this.iconRes = i;
