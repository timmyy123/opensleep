...
public class DeficitExtractor extends AbstractHourValueExtractor {
    private Context context;

    public DeficitExtractor(Context context) {
    ...
    public double getValue(IMeasureRecord iMeasureRecord) {
        return iMeasureRecord.getLengthInHours() - (SharedApplicationContext.getSettings().getIdealSleepMinutes() / 60.0f);
    }
}
