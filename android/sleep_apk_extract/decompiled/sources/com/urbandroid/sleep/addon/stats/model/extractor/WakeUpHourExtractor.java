...
public class WakeUpHourExtractor extends AbstractValueExtractor {
    private Context context;

    public WakeUpHourExtractor(Context context) {
    ...
    public String getMeasureName() {
        ...
        return context != null ? context.getString(R.string.category_wake_up) : "Wake up hour";
    }
    ...
    public double getValue(IMeasureRecord iMeasureRecord) {
        if (iMeasureRecord instanceof StatRecord) {
            return adjustHour(Math.min(23.0d, ((StatRecord) iMeasureRecord).getWakeUpHour()));
        }
        return 0.0d;
    }
