...
public abstract class ChartLoadSyncTask extends AsyncTask<Void, Integer, List<View>> {
    ...
    public ChartLoadSyncTask(ViewGroup viewGroup, Activity activity, ProgressBar progressBar) {
    ...
    public ChartLoadSyncTask setViewCount(int i) {
