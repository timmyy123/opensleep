...
public class EfficiencyPercentageExtractor extends AbstractPercentageFloatValueExtractor {
    private final Context context;

    public EfficiencyPercentageExtractor(Context context) {
    ...
    public double getValue(IMeasureRecord iMeasureRecord) {
        return ((((double) iMeasureRecord.getLengthInHours()) * 60.0d) / (((double) iMeasureRecord.getTrackLengthInHours()) * 60.0d)) * 100.0d;
    }
}
