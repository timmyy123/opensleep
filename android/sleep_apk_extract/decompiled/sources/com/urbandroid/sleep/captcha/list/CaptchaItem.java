...
public abstract class CaptchaItem<T extends RecyclerView.ViewHolder> {
    ...
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0007\b\u0086\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003j\u0002\b\u0004j\u0002\b\u0005j\u0002\b\u0006j\u0002\b\u0007¨\u0006\b"}, d2 = {"Lcom/urbandroid/sleep/captcha/list/CaptchaItem$Type;", "", "<init>", "(Ljava/lang/String;I)V", "CAPTCHA", "ADDON", "EMPTY", "RATE", "Sleep_prodRelease"}, k = 1, mv = {2, 3, 0}, xi = 48)
    public static final class Type {
        private static final /* synthetic */ EnumEntries $ENTRIES;
        private static final /* synthetic */ Type[] $VALUES;
        public static final Type CAPTCHA = new Type("CAPTCHA", 0);
        public static final Type ADDON = new Type("ADDON", 1);
        public static final Type EMPTY = new Type("EMPTY", 2);
        public static final Type RATE = new Type("RATE", 3);

        private static final /* synthetic */ Type[] $values() {
            return new Type[]{CAPTCHA, ADDON, EMPTY, RATE};
        }
    ...
    public CaptchaItem(Context context, int i, Type type) {
        context.getClass();
        type.getClass();
    ...
    public void bindView(T viewHolder) {
        viewHolder.getClass();
        viewHolder.itemView.setOnClickListener(new WebDialog$$ExternalSyntheticLambda1(this, 9));
    }
