...
public final class RestoreUnlockPreviewFragment extends AbstractPreviewFragment {
    ...
    public List<PreviewPage> getPages(Context c) {
        ...
        arrayList.add(new PreviewPage(r(c, R.string.unlock_restore_unlock_tutorial_title_2), r(c, R.string.unlock_restore_unlock_tutorial_desc_2), R.color.tint_background, R.color.tint_background, R.drawable.restore_unlock_install, -1));
        return arrayList;
    }
}
