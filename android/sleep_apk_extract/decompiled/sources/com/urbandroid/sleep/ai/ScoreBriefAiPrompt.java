...
@Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0006\u0018\u00002\u00020\u0001B\u0019\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\b\b\u0002\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0006\u0010\u0007J\u0010\u0010\t\u001a\u00020\bH\u0096@¢\u0006\u0004\b\t\u0010\nR\u0017\u0010\u0005\u001a\u00020\u00048\u0006¢\u0006\f\n\u0004\b\u0005\u0010\u000b\u001a\u0004\b\f\u0010\r¨\u0006\u000e"}, d2 = {"Lcom/urbandroid/sleep/ai/ScoreBriefAiPrompt;", "Lcom/urbandroid/sleep/ai/AiPrompt;", "Landroid/content/Context;", IntrospectionHelper.AppFunctionContextClass.CONTEXT_PROPERTY_NAME, "", "days", "<init>", "(Landroid/content/Context;I)V", "", "doLoad", "(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "I", "getDays", "()I", "Sleep_prodRelease"}, k = 1, mv = {2, 3, 0}, xi = 48)
public final class ScoreBriefAiPrompt extends AiPrompt {
    private final int days;

    /* JADX INFO: renamed from: com.urbandroid.sleep.ai.ScoreBriefAiPrompt$doLoad$1, reason: invalid class name */
    @Metadata(k = 3, mv = {2, 3, 0}, xi = 48)
    @DebugMetadata(c = "com.urbandroid.sleep.ai.ScoreBriefAiPrompt", f = "ScoreBriefAiPrompt.kt", l = {24}, m = "doLoad", v = 2)
    public static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return ScoreBriefAiPrompt.this.doLoad(this);
        }
    }

    public ScoreBriefAiPrompt(Context context, int i) {
        super(context, zza$$ExternalSyntheticOutline0.m(context, R.string.briefly), FileInsert$$ExternalSyntheticOutline0.m(context.getString(R.string.sleep_assistant_score), " (", context.getString(R.string.briefly), ")"));
        this.days = i;
    }
    ...
    */
    public Object doLoad(Continuation<? super String> continuation) {
        ...
        sb.append("Can you please summarize in 4 to 5 sentences in " + Locale.getDefault().getDisplayLanguage(Locale.ENGLISH) + " language how I'm doing regarding my sleep, what are my weak and strong points and what needs to be improved most? ");
        return sb.toString();
    }

    public /* synthetic */ ScoreBriefAiPrompt(Context context, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
