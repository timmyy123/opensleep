...
public final class SDNNDataProducer extends BTLEDataProducer {
    ...
    public ExtraValue[] extract(Intent intent) {
        intent.getClass();
        return RRIntervalsDataProducer.INSTANCE.getReceivingRRIntervals() ? new ExtraValue[0] : extract(intent, "com.urbandroid.sleep.EXTRA_DATA_SDNN", new IntRange(0, 1000));
    }
