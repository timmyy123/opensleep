...
public final class ZeppHttpServerService extends ForegroundService implements FeatureLogger {
    ...
    private static final String tag = "zepp";

    @Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0010\u000b\n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0017\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004H\u0007¢\u0006\u0004\b\u0007\u0010\bJ\u0017\u0010\t\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004H\u0007¢\u0006\u0004\b\t\u0010\bR\u001a\u0010\u000b\u001a\u00020\n8\u0016X\u0096D¢\u0006\f\n\u0004\b\u000b\u0010\f\u001a\u0004\b\r\u0010\u000eR\"\u0010\u0010\u001a\u00020\u000f8\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u0010\u0010\u0011\u001a\u0004\b\u0012\u0010\u0013\"\u0004\b\u0014\u0010\u0015¨\u0006\u0016"}, d2 = {"Lcom/urbandroid/sleep/smartwatch/zepp/ZeppHttpServerService$Companion;", "Lcom/urbandroid/common/FeatureLogger;", "<init>", "()V", "Landroid/content/Context;", IntrospectionHelper.AppFunctionContextClass.CONTEXT_PROPERTY_NAME, "", "start", "(Landroid/content/Context;)V", "stop", "", "tag", "Ljava/lang/String;", "getTag", "()Ljava/lang/String;", "", "running", "Z", "getRunning", "()Z", "setRunning", "(Z)V", "Sleep_prodRelease"}, k = 1, mv = {2, 3, 0}, xi = 48)
    public static final class Companion implements FeatureLogger {
        ...
        public String getTag() {
            return ZeppHttpServerService.tag;
        }

        public final void setRunning(boolean z) {
            ZeppHttpServerService.running = z;
        }
        ...
        public final void stop(Context context) {
            context.getClass();
            setRunning(false);
            Intent intent = new Intent(context, (Class<?>) ZeppHttpServerService.class);
            intent.setAction("com.urbandroid.sleep.zepp.STOP_SERVICE");
    ...
    /* JADX INFO: renamed from: com.urbandroid.sleep.smartwatch.zepp.ZeppHttpServerService$onCreate$1, reason: invalid class name */
    @Metadata(d1 = {"\u0000\u0019\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u001a\u0010\u0002\u001a\n \u0004*\u0004\u0018\u00010\u00030\u00032\b\u0010\u0005\u001a\u0004\u0018\u00010\u0006H\u0016¨\u0006\u0007"}, d2 = {"com/urbandroid/sleep/smartwatch/zepp/ZeppHttpServerService$onCreate$1", "Lfi/iki/elonen/NanoHTTPD;", "serve", "Lfi/iki/elonen/NanoHTTPD$Response;", "kotlin.jvm.PlatformType", "session", "Lfi/iki/elonen/NanoHTTPD$IHTTPSession;", "Sleep_prodRelease"}, k = 1, mv = {2, 3, 0}, xi = 48)
    public static final class AnonymousClass1 extends NanoHTTPD {
        ...
        public static final CharSequence serve$lambda$1(ZeppMessage zeppMessage) {
            zeppMessage.getClass();
            return zeppMessage.toJson();
        }
        ...
        public NanoHTTPD.Response serve(NanoHTTPD.IHTTPSession session) {
            ...
            try {
                try {
                    ZeppHttpServerService.this.lastWatchMessageTimestamp = System.currentTimeMillis();
                    if (session != null) {
                        ZeppHttpServerService zeppHttpServerService = ZeppHttpServerService.this;
                        ...
                        zeppHttpServerService.handleFromWatch(strSubstring, str, handler);
                    }
                    String strJoinToString$default = CollectionsKt.joinToString$default(CollectionsKt.toList(ZeppHttpServerService.this.messageQueue), ",", "[", "]", new URLUtilsKt$$ExternalSyntheticLambda0(8), 24);
                    if (!strJoinToString$default.equals("[]")) {
                        ZeppHttpServerService zeppHttpServerService2 = ZeppHttpServerService.this;
                        String strConcat = "toWatch ".concat(strJoinToString$default);
                        Logger.logDebug(Logger.defaultTag, zeppHttpServerService2.getTag() + ": " + strConcat, null);
                    }
                    responseNewFixedLengthResponse = NanoHTTPD.newFixedLengthResponse(strJoinToString$default);
                } catch (Exception e) {
                    ZeppHttpServerService zeppHttpServerService3 = ZeppHttpServerService.this;
                    Logger.logSevere(Logger.defaultTag, zeppHttpServerService3.getTag() + ": Fitbit server err: ", e);
                ...
                ZeppHttpServerService.this.messageQueue.clear();
    ...
    /* JADX WARN: Type inference failed for: r0v4, types: [com.urbandroid.sleep.smartwatch.zepp.ZeppHttpServerService$receiver$1] */
    public ZeppHttpServerService() {
        super("sleepTrackingChannel", 6767, R.drawable.ic_action_watch_white);
        this.tag = "zepp";
        this.lastWatchMessageTimestamp = -1L;
        this.messageQueue = new ArrayList();
        this.receiver = new BroadcastReceiver() { // from class: com.urbandroid.sleep.smartwatch.zepp.ZeppHttpServerService$receiver$1
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                ZeppHttpServerService zeppHttpServerService = this.this$0;
                switch (action.hashCode()) {
                    case -1934775263:
                        if (action.equals("com.urbandroid.sleep.watch.START_TRACKING")) {
                            Bundle extras = intent.getExtras();
                            zeppHttpServerService.handleFromPhone(action, String.valueOf(extras != null ? extras.get("DO_HR_MONITORING") : null));
                            zeppHttpServerService.messageQueue.add(new ZeppMessage("set_multi", ""));
                            return;
                        }
                        break;
                    case -1021645561:
                        if (action.equals("com.urbandroid.sleep.watch.START_ALARM")) {
                            ...
                            zeppHttpServerService.handleFromPhone(action, String.valueOf(extras2 != null ? extras2.get("DELAY") : null));
                            return;
                        }
                        break;
                    case -291818132:
                        if (action.equals("com.urbandroid.sleep.watch.SET_PAUSE")) {
                            ...
                            zeppHttpServerService.handleFromPhone(action, String.valueOf(extras3 != null ? extras3.get("TIMESTAMP") : null));
                            return;
                        }
                        break;
                    case -52158809:
                        if (action.equals("com.urbandroid.sleep.watch.STOP_TRACKING")) {
                            String string = zeppHttpServerService.getString(R.string.fitbit_standby);
                            string.getClass();
                            zeppHttpServerService.updateNotification(string);
                            zeppHttpServerService.handleFromPhone(action, "");
                            return;
                        }
                        break;
                    case 463493168:
                        if (action.equals("com.urbandroid.sleep.watch.SET_BATCH_SIZE")) {
                            ...
                            zeppHttpServerService.handleFromPhone(action, String.valueOf(extras4 != null ? extras4.get("SIZE") : null));
                            return;
                        }
                        break;
                    case 865944712:
                        if (action.equals("com.urbandroid.sleep.watch.UPDATE_ALARM")) {
                            ...
                            zeppHttpServerService.handleFromPhone(action, obj + ":" + obj2 + ":" + (extras7 != null ? extras7.get("TIMESTAMP") : null));
                            return;
                        }
                        break;
                }
    ...
    private final Notification getNotification(String text) {
        ...
        Intent intent2 = new Intent(getApplicationContext(), (Class<?>) ZeppHttpServerService.class);
        intent2.setAction("com.urbandroid.sleep.zepp.STOP_SERVICE");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean handleFromWatch$lambda$0(ZeppMessage zeppMessage) {
        zeppMessage.getClass();
        return Intrinsics.areEqual(zeppMessage.getName(), "stop");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void handleFromWatch$lambda$1(ZeppHttpServerService zeppHttpServerService) {
        ContextExtKt.sendExplicitBroadcast$default(zeppHttpServerService, new Intent("com.urbandroid.sleep.watch.STARTED_ON_WATCH"), null, 2, null);
    }
    ...
    public final void handleFromPhone(String action, String data2) {
        action.getClass();
        data2.getClass();
        this.messageQueue.add(new ZeppMessage(toMessage(action), data2));
    }
        ...
        switch (command.hashCode()) {
            ...
            case 3540994:
                if (command.equals("stop")) {
                    ...
                    handler.postDelayed(new Runnable(this) { // from class: com.urbandroid.sleep.smartwatch.zepp.ZeppHttpServerService$$ExternalSyntheticLambda1
                        public final /* synthetic */ ZeppHttpServerService f$0;
                        ...
                        public final void run() {
                            int i3 = i;
                            ZeppHttpServerService zeppHttpServerService = this.f$0;
                            switch (i3) {
                                case 0:
                                    ZeppHttpServerService.handleFromWatch$lambda$1(zeppHttpServerService);
                                    break;
                                default:
                                    zeppHttpServerService.stopSelf();
                                    break;
                            }
                        }
                    }, 10000L);
            ...
            case 109757538:
                if (command.equals("start")) {
                    CollectionsKt__MutableCollectionsKt.removeAll(this.messageQueue, new URLUtilsKt$$ExternalSyntheticLambda0(7));
                    updateNotification(FileInsert$$ExternalSyntheticOutline0.m("Fitbit: ", getString(R.string.settings_category_track)));
                    handler.post(new Runnable(this) { // from class: com.urbandroid.sleep.smartwatch.zepp.ZeppHttpServerService$$ExternalSyntheticLambda1
                        public final /* synthetic */ ZeppHttpServerService f$0;
    ...
    public void onCreate() {
        ...
        ZeppHttpServerService$receiver$1 zeppHttpServerService$receiver$1 = this.receiver;
        ...
        Unit unit = Unit.INSTANCE;
        ContextCompat.registerReceiver(this, zeppHttpServerService$receiver$1, intentFilter, 2);
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (!Intrinsics.areEqual(intent != null ? intent.getAction() : null, "com.urbandroid.sleep.zepp.STOP_SERVICE")) {
            return 1;
        }
