                    ...
                    if (settableBeanPropertyFindCreatorProperty == null) {
                        ...
                        try {
                            ...
                            if (objBuild.getClass() != this._beanType.getRawClass()) {
                                ...
                                deserializationContext.reportBadDefinition(javaType, Fragment$$ExternalSyntheticOutline1.m("Cannot support implicit polymorphic deserialization for POJOs-as-Arrays style: nominal type ", ClassUtil.getTypeDescription(javaType), ", actual type ", ClassUtil.getClassDescription(objBuild)));
                            }
                        } catch (Exception e2) {
