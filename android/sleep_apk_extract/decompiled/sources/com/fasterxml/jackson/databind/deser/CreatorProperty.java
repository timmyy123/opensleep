...
public class CreatorProperty extends SettableBeanProperty {
    ...
    private void _reportMissingSetter(JsonParser jsonParser, DeserializationContext deserializationContext) throws InvalidDefinitionException {
        ...
        String strM = FileInsert$$ExternalSyntheticOutline0.m("No fallback setter/field defined for creator property ", ClassUtil.name(getName()), " (of ", annotatedParameter == null ? "UNKNOWN TYPE" : ClassUtil.getClassDescription(annotatedParameter.getOwner().getDeclaringClass()), ")");
        if (deserializationContext == null) {
            throw InvalidDefinitionException.from(jsonParser, strM, getType());
        }
        deserializationContext.reportBadDefinition(getType(), strM);
    }
