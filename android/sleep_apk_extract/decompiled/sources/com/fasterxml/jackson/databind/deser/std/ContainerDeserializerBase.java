...
public abstract class ContainerDeserializerBase<T> extends StdDeserializer<T> {
    ...
    public SettableBeanProperty findBackReference(String str) {
        ...
        Utf8$$ExternalSyntheticBUOutline0.m$2(FileInsert$$ExternalSyntheticOutline0.m("Cannot handle managed/back reference '", str, "': type: container deserializer of type ", getClass().getName(), " returned null for 'getContentDeserializer()'"));
        return null;
    }
