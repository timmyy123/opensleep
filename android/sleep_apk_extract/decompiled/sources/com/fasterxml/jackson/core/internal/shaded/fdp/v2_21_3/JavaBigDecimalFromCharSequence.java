...
final class JavaBigDecimalFromCharSequence extends AbstractBigDecimalParser {
    public BigDecimal parseBigDecimalString(CharSequence charSequence, int i, int i2) {
        ...
        try {
            ...
            if (z2 || cCharAt == '+') {
                i6++;
                cCharAt = AbstractNumberParser.charAt(charSequence, i6, iCheckBounds);
                if (cCharAt == 0) {
            ...
            while (true) {
                ...
                if (c2 >= '\n') {
                    ...
                    z3 |= i8 >= 0;
                    int i10 = i9;
                    while (i10 < iCheckBounds - 4 && (iTryToParseFourDigits = FastDoubleSwar.tryToParseFourDigits(charSequence, i10 + 1)) >= 0) {
            ...
            if ((cCharAt2 | ' ') == 101) {
                int i11 = i9 + 1;
                char cCharAt3 = AbstractNumberParser.charAt(charSequence, i11, iCheckBounds);
                boolean z4 = cCharAt3 == '-' ? z : false;
                if (z4 || cCharAt3 == '+') {
                    i11 = i9 + 2;
                    cCharAt3 = AbstractNumberParser.charAt(charSequence, i11, iCheckBounds);
                }
                ...
                while (true) {
                    ...
                    j2 = j4;
                    i11++;
                    char cCharAt4 = (char) (AbstractNumberParser.charAt(charSequence, i11, iCheckBounds) - '0');
                    if (cCharAt4 >= '\n') {
                        break;
                    }
                    j4 = j2;
            ...
            if (i3 >= 19) {
                return valueOfBigDecimalString(charSequence, i7, i4, i4 + 1, i9, z2, (int) j5);
            }
            if (z2) {
                j3 = -j3;
            }
