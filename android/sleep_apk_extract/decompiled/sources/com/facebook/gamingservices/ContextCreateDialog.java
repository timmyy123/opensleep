...
public final class ContextCreateDialog extends FacebookDialogBase<ContextCreateContent, Result> {
    ...
    public final class FacebookAppHandler extends FacebookDialogBase<ContextCreateContent, Result>.ModeHandler {
        ...
        public AppCall createAppCall(ContextCreateContent content) {
            ...
            intent.setType("text/plain");
            AccessToken currentAccessToken = AccessToken.INSTANCE.getCurrentAccessToken();
            Bundle bundleM = zzba$$ExternalSyntheticOutline0.m(SDKConstants.PARAM_TOURNAMENTS_DEEPLINK, "CONTEXT_CREATE");
            ...
            if (content.getSuggestedPlayerID() != null) {
                bundleM.putString("player_id", content.getSuggestedPlayerID());
            }
    ...
    private final void showForCloud(ContextCreateContent content) {
        ...
        if (currentAccessToken == null || currentAccessToken.isExpired()) {
            FacebookSdk$$ExternalSyntheticLambda1.m("Attempted to open ContextCreateContent with an invalid access token");
            return;
        }
        LoginFragment$$ExternalSyntheticLambda0 loginFragment$$ExternalSyntheticLambda0 = new LoginFragment$$ExternalSyntheticLambda0(this, 6);
        JSONObject jSONObject = new JSONObject();
        try {
            if (content.getSuggestedPlayerID() != null) {
                jSONObject.put("id", content.getSuggestedPlayerID());
            }
            DaemonRequest.executeAsync(getActivityContext(), jSONObject, loginFragment$$ExternalSyntheticLambda0, SDKMessageEnum.CONTEXT_CREATE);
    ...
    public void registerCallbackImpl(CallbackManagerImpl callbackManager, final FacebookCallback<Result> callback) {
        ...
        callbackManager.registerCallback(getRequestCodeField(), new ContextChooseDialog$$ExternalSyntheticLambda0(this, new ResultProcessor(callback) { // from class: com.facebook.gamingservices.ContextCreateDialog$registerCallbackImpl$resultProcessor$1
