...
public abstract class AbstractC1873oX<K, V> implements Map<K, V>, Serializable {
    ...
    @CheckForNull
    @LazyInit
    public transient AbstractC1864oO<V> A00;
     ...
     */
    public static <K, V> AbstractC1873oX<K, V> A05(Iterable<? extends Map.Entry<? extends K, ? extends V>> entries) {
        C1871oV c1871oV = new C1871oV(entries instanceof Collection ? ((Collection) entries).size() : 4);
        c1871oV.A04(entries);
        return c1871oV.A07();
    }
    ...
    public abstract AbstractC1864oO<V> A0A();
    ...
    public static <K, V> C1871oV<K, V> A03() {
        return new C1871oV<>();
    }

    public static <K, V> AbstractC1873oX<K, V> A04() {
        AbstractC1873oX<K, V> abstractC1873oX = (AbstractC1873oX<K, V>) B9.A04;
        if (A04[4].charAt(3) != 'V') {
    ...
    public static <K, V> AbstractC1873oX<K, V> A06(Map<? extends K, ? extends V> map) {
        if ((map instanceof AbstractC1873oX) && !(map instanceof SortedMap)) {
            AbstractC1873oX<K, V> abstractC1873oX = (AbstractC1873oX) map;
            if (!abstractC1873oX.A0F()) {
                return abstractC1873oX;
            }
        }
    ...
    public AbstractC1864oO<V> values() {
        AbstractC1864oO<V> abstractC1864oOA0A = this.A00;
        if (abstractC1864oOA0A == null) {
            abstractC1864oOA0A = A0A();
            if (A04[3].length() == 23) {
                throw new RuntimeException();
            }
            A04[6] = "23ujWmcydF5ICCpn56C";
            this.A00 = abstractC1864oOA0A;
        }
        return abstractC1864oOA0A;
    }
    ...
    public final String toString() {
        return AbstractC1951po.A08(this);
    }
}
