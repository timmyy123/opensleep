...
public final class C02274u {
    ...
    public C02274u(byte[] bArr) {
        this(bArr, bArr.length);
    }

    public C02274u(byte[] bArr, int i) {
        this.A00 = bArr;
        this.A02 = i;
    }

    private void A00() {
        AbstractC02053y.A08(this.A03 >= 0 && (this.A03 < this.A02 || (this.A03 == this.A02 && this.A01 == 0)));
    }
    ...
    public final void A0C(C02284v c02284v) {
        A0E(c02284v.A0l(), c02284v.A0A());
        A08(c02284v.A09() * 8);
    }
    ...
    public final void A0F(byte[] bArr, int i, int i2) {
        ...
        int to5 = PHIpAddressSearchManager.END_IP_SCAN >> i7;
        ...
        if (to6 + i7 > 8) {
            ...
            int to7 = bitsLeft2 + 1;
            this.A03 = to7;
            int bitsLeft3 = bArr4[bitsLeft2] & PHIpAddressSearchManager.END_IP_SCAN;
            int to8 = this.A01;
