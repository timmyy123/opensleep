...
public final class C1050ah extends ProgressBar {
    public static final int A02 = Color.argb(26, 0, 0, 0);
    public static final int A03 = Color.rgb(88, 144, PHIpAddressSearchManager.END_IP_SCAN);
    public Paint A00;
    public Rect A01;

    public C1050ah(C1421gi c1421gi, AttributeSet attributeSet, int i) {
