...
public final class zzra implements Flow {
    final /* synthetic */ Flow zza;
    final /* synthetic */ zzrb zzb;

    public zzra(Flow flow, zzrb zzrbVar) {
        this.zza = flow;
        this.zzb = zzrbVar;
    }
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object objCollect = this.zza.collect(new zzqz(flowCollector, this.zzb), continuation);
