...
public final class zzpb implements Flow {
    final /* synthetic */ Flow zza;
    final /* synthetic */ zzpj zzb;

    public zzpb(Flow flow, zzpj zzpjVar) {
        this.zza = flow;
        this.zzb = zzpjVar;
    }
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object objCollect = this.zza.collect(new zzpa(flowCollector, this.zzb), continuation);
