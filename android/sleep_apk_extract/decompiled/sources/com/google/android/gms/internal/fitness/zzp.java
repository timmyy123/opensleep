...
public final class zzp extends zze {
    ...
    static {
        ...
        zze = clientKey;
        byte[] bArr = null;
        zzf = new Api("Fitness.CONFIG_API", new zzl(bArr), clientKey);
        zzg = new Api("Fitness.CONFIG_CLIENT", new zzn(bArr), clientKey);
    }

    public /* synthetic */ zzp(Context context, Looper looper, ClientSettings clientSettings, GoogleApiClient.ConnectionCallbacks connectionCallbacks, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener, byte[] bArr) {
