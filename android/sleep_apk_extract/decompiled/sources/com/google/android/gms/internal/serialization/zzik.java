...
public final class zzik implements Flow {
    final /* synthetic */ Flow zza;
    final /* synthetic */ AutomationController zzb;

    public zzik(Flow flow, AutomationController automationController) {
        this.zza = flow;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object objCollect = this.zza.collect(new zzij(flowCollector, this.zzb), continuation);
