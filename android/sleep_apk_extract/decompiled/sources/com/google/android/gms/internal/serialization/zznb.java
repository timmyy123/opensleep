...
public final class zznb implements Flow {
    final /* synthetic */ Flow zza;
    final /* synthetic */ zznc zzb;

    public zznb(Flow flow, zznc zzncVar) {
        this.zza = flow;
        this.zzb = zzncVar;
    }
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object objCollect = this.zza.collect(new zzna(flowCollector, this.zzb), continuation);
