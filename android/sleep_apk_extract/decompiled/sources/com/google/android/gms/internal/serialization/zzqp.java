...
public final class zzqp implements Flow {
    final /* synthetic */ Flow zza;
    final /* synthetic */ zzqq zzb;

    public zzqp(Flow flow, zzqq zzqqVar) {
        this.zza = flow;
        this.zzb = zzqqVar;
    }
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object objCollect = this.zza.collect(new zzqo(flowCollector, this.zzb), continuation);
