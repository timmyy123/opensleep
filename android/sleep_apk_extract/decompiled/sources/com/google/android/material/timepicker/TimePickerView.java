...
class TimePickerView extends ConstraintLayout {
    ...
    public TimePickerView(Context context, AttributeSet attributeSet, int i) {
        ...
        materialButtonToggleGroup.addOnButtonCheckedListener(new TimePickerView$$ExternalSyntheticLambda0(this, 0));
        ...
        clockFaceView.setOnEnterKeyPressedListener(new TimePickerView$$ExternalSyntheticLambda1(this));
        setupDoubleTap();
        setUpDisplay();
    }
