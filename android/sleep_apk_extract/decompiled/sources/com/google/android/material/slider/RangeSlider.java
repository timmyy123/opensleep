...
import com.urbandroid.sleep.NewAddRecordActivity$$ExternalSyntheticLambda9;
import java.util.ArrayList;
import java.util.List;

/* JADX INFO: loaded from: classes4.dex */
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, Object> {
    private float minSeparation;
    private int separationUnit;

    public interface OnChangeListener extends BaseOnChangeListener<RangeSlider> {
        @Override // com.google.android.material.slider.BaseOnChangeListener
        default void onValueChange(RangeSlider rangeSlider, float f, boolean z) {
            ((NewAddRecordActivity$$ExternalSyntheticLambda9) this).f$0.lambda$onCreate$8(rangeSlider, f, z);
        }
    }
