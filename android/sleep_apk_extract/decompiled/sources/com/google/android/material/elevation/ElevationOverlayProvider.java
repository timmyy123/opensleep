...
public class ElevationOverlayProvider {
    ...
    private boolean isThemeSurfaceColor(int i) {
        return ColorUtils.setAlphaComponent(i, PHIpAddressSearchManager.END_IP_SCAN) == this.colorSurface;
    }
    ...
    public int compositeOverlay(int i, float f) {
        ...
        int iLayer = MaterialColors.layer(ColorUtils.setAlphaComponent(i, PHIpAddressSearchManager.END_IP_SCAN), this.elevationOverlayColor, fCalculateOverlayAlphaFraction);
