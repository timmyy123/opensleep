...
public final class FirebaseAIOnDeviceUnknownException extends FirebaseAIException {
    ...
    public FirebaseAIOnDeviceUnknownException(FirebaseAIOnDeviceException firebaseAIOnDeviceException) {
        firebaseAIOnDeviceException.getClass();
        String message = firebaseAIOnDeviceException.getMessage();
        super(message == null ? "Unknown on-device exception" : message, firebaseAIOnDeviceException);
    }
}
