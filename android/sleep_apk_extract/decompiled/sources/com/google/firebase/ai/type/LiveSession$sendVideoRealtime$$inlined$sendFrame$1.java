...
public final class LiveSession$sendVideoRealtime$$inlined$sendFrame$1 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    final /* synthetic */ Object $data;
    int label;
    final /* synthetic */ LiveSession this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LiveSession$sendVideoRealtime$$inlined$sendFrame$1(Object obj, LiveSession liveSession, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new LiveSession$sendVideoRealtime$$inlined$sendFrame$1(this.$data, this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Continuation<? super Unit> continuation) {
        return ((LiveSession$sendVideoRealtime$$inlined$sendFrame$1) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
