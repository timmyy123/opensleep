...
public abstract class LibraryVersionComponent {
    ...
    public static Component<?> fromContext(String str, VersionExtractor<Context> versionExtractor) {
        return Component.intoSetBuilder(LibraryVersion.class).add(Dependency.required((Class<?>) Context.class)).factory(new ComponentMonitor$$ExternalSyntheticLambda0(str, versionExtractor, 1)).build();
    }
