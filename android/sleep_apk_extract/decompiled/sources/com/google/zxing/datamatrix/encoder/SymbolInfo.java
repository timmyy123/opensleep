...
public class SymbolInfo {
    ...
    private int getHorizontalDataRegions() {
        ...
        if (i != 1) {
            ...
            if (i != 2 && i != 4) {
                ...
                Utf8$$ExternalSyntheticBUOutline0.m$3("Cannot handle this number of data regions");
                return 0;
            }
        }
        return i2;
    ...
    public static SymbolInfo lookup(int i, SymbolShapeHint symbolShapeHint, Dimension dimension, Dimension dimension2, boolean z) {
        ...
        Utf8$$ExternalSyntheticBUOutline0.m$2("Can't find a symbol arrangement that matches the message. Data codewords: ".concat(String.valueOf(i)));
        return null;
    }
