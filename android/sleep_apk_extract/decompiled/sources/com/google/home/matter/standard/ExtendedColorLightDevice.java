...
public final class ExtendedColorLightDevice extends DeviceType {
    ...
    public ExtendedColorLightDevice(DeviceType.Metadata metadata, TraitProvider traitProvider, HasEvents hasEvents, GoogleTraits googleTraits, StandardTraits standardTraits) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExtendedColorLightDevice)) {
            return false;
        }
        ExtendedColorLightDevice extendedColorLightDevice = (ExtendedColorLightDevice) other;
        return Intrinsics.areEqual(this.googleTraits, extendedColorLightDevice.googleTraits) && Intrinsics.areEqual(this.standardTraits, extendedColorLightDevice.standardTraits) && Intrinsics.areEqual(extendedColorLightDevice.getMetadata(), getMetadata());
    }

    @Override // com.google.home.DeviceType
    public DeviceTypeFactory<ExtendedColorLightDevice> getFactory() {
        return this.factory;
    }
    ...
    public String toString() {
        ...
        return zzy.zza(standardTraits5, standardTraits4, standardTraits3, standardTraits2, standardTraits, googleTraits3, googleTraits2, googleTraits, new StringBuilder(length + 48 + length2 + 14 + length3 + 35 + length4 + 39 + length5 + 10 + length6 + 16 + length7 + 20 + length8 + 27 + String.valueOf(standardTraits5).length() + 17), metadata, "ExtendedColorLightDevice(metadata=", ".extendedColorControl,),standardTraits=", ".lightEffects,extendedColorControl=", "(identify=", ".identify,onOff=", ".onOff,levelControl=", ".levelControl,colorControl=", ",googleTraits=", "(lightEffects=", ".colorControl,),)");
    }

    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004J\b\u0010\u0007\u001a\u00020\u0006H\u0016R\u000e\u0010\u0005\u001a\u00020\u0006X\u0086T¢\u0006\u0002\n\u0000¨\u0006\b"}, d2 = {"Lcom/google/home/matter/standard/ExtendedColorLightDevice$Companion;", "Lcom/google/home/DeviceTypeFactory;", "Lcom/google/home/matter/standard/ExtendedColorLightDevice;", "<init>", "()V", "TYPE_ID", "", InAppPurchaseConstants.METHOD_TO_STRING, "java.com.google.home.matter.standard_device_types-android"}, k = 1, mv = {2, 0, 0}, xi = 48)
    public static final class Companion extends DeviceTypeFactory<ExtendedColorLightDevice> {
        private Companion() {
            super(Factory.INSTANCE);
        }

        public String toString() {
            return "matter.standard.type.ExtendedColorLightDevice";
        }
    ...
    @Metadata(d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bÂ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004JN\u0010\u0005\u001a\u00020\u00022\u0018\u0010\u0006\u001a\u0014\u0012\b\u0012\u0006\u0012\u0002\b\u00030\b\u0012\u0006\u0012\u0004\u0018\u00010\t0\u00072\u001a\u0010\n\u001a\u0016\u0012\f\u0012\n\u0012\u0004\u0012\u00020\t\u0018\u00010\f\u0012\u0004\u0012\u00020\r0\u000b2\u0006\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0010\u001a\u00020\u0011H\u0016¨\u0006\u0012"}, d2 = {"Lcom/google/home/matter/standard/ExtendedColorLightDevice$Factory;", "Lcom/google/home/matter/MatterDeviceTypeFactory;", "Lcom/google/home/matter/standard/ExtendedColorLightDevice;", "<init>", "()V", "createType", "traits", "", "Lcom/google/home/TraitFactory;", "Lcom/google/home/Trait;", "metadataBuilder", "Lkotlin/Function1;", "", "Lcom/google/home/DeviceType$Metadata;", "traitProvider", "Lcom/google/home/TraitProvider;", "eventProvider", "Lcom/google/home/HasEvents;", "java.com.google.home.matter.standard_device_types-android"}, k = 1, mv = {2, 0, 0}, xi = 48)
    public static final class Factory extends MatterDeviceTypeFactory<ExtendedColorLightDevice> {
        public static final Factory INSTANCE = new Factory();

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        private Factory() {
            super("home.matter.0000.types.010d", CollectionsKt.listOf((Object[]) new TraitFactory[]{Identify.INSTANCE, OnOff.INSTANCE, LevelControl.INSTANCE, ColorControl.INSTANCE, LightEffects.INSTANCE, ExtendedColorControl.INSTANCE}), null);
            Id.m441constructorimpl("home.matter.0000.types.010d");
        }

        @Override // com.google.home.matter.MatterDeviceTypeFactory
        public ExtendedColorLightDevice createType(Map<TraitFactory<?>, ? extends Trait> traits, Function1<? super List<? extends Trait>, DeviceType.Metadata> metadataBuilder, TraitProvider traitProvider, HasEvents eventProvider) {
            traits.getClass();
