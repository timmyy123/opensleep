...
public final class ExtendedMediaPlaybackImpl extends MatterTraitImpl implements ExtendedMediaPlayback, ExtendedMediaPlaybackTrait.Attributes {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExtendedMediaPlaybackImpl)) {
            return false;
        }
        ExtendedMediaPlaybackImpl extendedMediaPlaybackImpl = (ExtendedMediaPlaybackImpl) other;
        return Intrinsics.areEqual(getMetadata(), extendedMediaPlaybackImpl.getMetadata()) && Intrinsics.areEqual(this.attributes, extendedMediaPlaybackImpl.attributes);
    }
    ...
    @Override // com.google.home.google.ExtendedMediaPlaybackTrait.Attributes
    public ExtendedMediaPlaybackTrait.ExtendedPlaybackState getExtendedCurrentState() {
        return this.attributes.getExtendedCurrentState();
    }
