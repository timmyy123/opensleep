...
public final class SequentialFlow extends Node {
    private final List<Node> nodes;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public SequentialFlow(List<? extends Node> list, String str) {
        super(str, null);
        list.getClass();
        str.getClass();
        this.nodes = list;
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SequentialFlow) && super.equals(other) && Intrinsics.areEqual(this.nodes, ((SequentialFlow) other).nodes);
    }
    ...
    public String toString() {
        return zzc.zza(this.nodes, this, (byte) 30, "SequentialFlow(nodes=");
    }
}
