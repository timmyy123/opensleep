...
public final class MapKeys extends ExpressionWithId {
    private final Expression mapExpression;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MapKeys(Expression expression, String str) {
        super(str, null);
        expression.getClass();
        str.getClass();
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof MapKeys) && super.equals(other) && Intrinsics.areEqual(this.mapExpression, ((MapKeys) other).mapExpression);
    }
    ...
    public String toString() {
        return zzd.zza(this.mapExpression, this, (byte) 37, "MapKeys(mapExpression=");
    }
}
