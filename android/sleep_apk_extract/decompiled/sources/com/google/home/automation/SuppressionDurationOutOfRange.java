...
public final class SuppressionDurationOutOfRange extends ValidationIssue {
    private final Duration duration;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SuppressionDurationOutOfRange(Node node, ValidationIssueSeverity validationIssueSeverity, Duration duration) {
        super(node, validationIssueSeverity, ValidationIssueType.SuppressionDurationOutOfRange, null);
        node.getClass();
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SuppressionDurationOutOfRange) && Intrinsics.areEqual(this.duration, ((SuppressionDurationOutOfRange) other).duration) && super.equals(other);
    }
