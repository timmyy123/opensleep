...
public final class MapValues extends ExpressionWithId {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof MapValues) && super.equals(other) && Intrinsics.areEqual(this.mapExpression, ((MapValues) other).mapExpression);
    }

    @Override // com.google.home.automation.ExpressionWithId
    public int hashCode() {
        return this.mapExpression.hashCode() + (super.hashCode() * 31);
    }

    public String toString() {
        return zzd.zza(this.mapExpression, this, (byte) 39, "MapValues(mapExpression=");
    }
}
