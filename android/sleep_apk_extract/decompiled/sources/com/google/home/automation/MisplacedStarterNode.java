...
public final class MisplacedStarterNode extends ValidationIssue {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MisplacedStarterNode(Node node, ValidationIssueSeverity validationIssueSeverity) {
        super(node, validationIssueSeverity, ValidationIssueType.MisplacedStarterNode, null);
        node.getClass();
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof MisplacedStarterNode) {
