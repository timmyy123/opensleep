...
public final class MapSize extends ExpressionWithId {
    private final Expression mapExpression;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MapSize(Expression expression, String str) {
        super(str, null);
        expression.getClass();
        str.getClass();
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof MapSize) && super.equals(other) && Intrinsics.areEqual(this.mapExpression, ((MapSize) other).mapExpression);
    }
    ...
    public String toString() {
        return zzd.zza(this.mapExpression, this, (byte) 37, "MapSize(mapExpression=");
    }
}
