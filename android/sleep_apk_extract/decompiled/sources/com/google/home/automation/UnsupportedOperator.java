...
public final class UnsupportedOperator extends ValidationIssue {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UnsupportedOperator(Node node, ValidationIssueSeverity validationIssueSeverity) {
        super(node, validationIssueSeverity, ValidationIssueType.UnsupportedOperator, null);
        node.getClass();
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof UnsupportedOperator) {
