...
public final class UnsubscribableAttribute extends ValidationIssue {
    private final String attributeName;
    private final String traitId;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UnsubscribableAttribute(Node node, ValidationIssueSeverity validationIssueSeverity, String str, String str2) {
        super(node, validationIssueSeverity, ValidationIssueType.UnsubscribableAttribute, null);
        node.getClass();
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof UnsubscribableAttribute)) {
            return false;
        }
        UnsubscribableAttribute unsubscribableAttribute = (UnsubscribableAttribute) other;
        return Intrinsics.areEqual(this.traitId, unsubscribableAttribute.traitId) && Intrinsics.areEqual(this.attributeName, unsubscribableAttribute.attributeName) && super.equals(other);
    }
