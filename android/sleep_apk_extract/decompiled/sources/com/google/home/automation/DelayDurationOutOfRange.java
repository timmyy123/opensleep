...
public final class DelayDurationOutOfRange extends ValidationIssue {
    private final Duration duration;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DelayDurationOutOfRange(Node node, ValidationIssueSeverity validationIssueSeverity, Duration duration) {
        super(node, validationIssueSeverity, ValidationIssueType.DelayDurationOutOfRange, null);
        node.getClass();
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof DelayDurationOutOfRange) && Intrinsics.areEqual(this.duration, ((DelayDurationOutOfRange) other).duration) && super.equals(other);
    }
