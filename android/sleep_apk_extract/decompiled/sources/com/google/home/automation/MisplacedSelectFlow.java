...
public final class MisplacedSelectFlow extends ValidationIssue {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MisplacedSelectFlow(Node node, ValidationIssueSeverity validationIssueSeverity) {
        super(node, validationIssueSeverity, ValidationIssueType.MisplacedSelectFlow, null);
        node.getClass();
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof MisplacedSelectFlow) {
