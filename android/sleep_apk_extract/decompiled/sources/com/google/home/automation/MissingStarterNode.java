...
public final class MissingStarterNode extends ValidationIssue {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MissingStarterNode(Node node, ValidationIssueSeverity validationIssueSeverity) {
        super(node, validationIssueSeverity, ValidationIssueType.MissingStarterNode, null);
        node.getClass();
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof MissingStarterNode) {
