...
public final class ConditionDurationOutOfRange extends ValidationIssue {
    private final Duration duration;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ConditionDurationOutOfRange(Node node, ValidationIssueSeverity validationIssueSeverity, Duration duration) {
        super(node, validationIssueSeverity, ValidationIssueType.ConditionDurationOutOfRange, null);
        node.getClass();
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ConditionDurationOutOfRange) && Intrinsics.areEqual(this.duration, ((ConditionDurationOutOfRange) other).duration) && super.equals(other);
    }
