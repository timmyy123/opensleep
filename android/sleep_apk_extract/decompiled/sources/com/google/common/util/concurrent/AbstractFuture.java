        ...
        static {
            ...
            try {
                try {
                    ...
                    Utf8$$ExternalSyntheticBUOutline0.m("Could not initialize intrinsics", e.getCause());
                    return;
                }
            ...
            try {
                ...
                VALUE_OFFSET = unsafe.objectFieldOffset(AbstractFuture.class.getDeclaredField(SDKConstants.PARAM_VALUE));
    ...
    private void addPendingString(StringBuilder sb) {
        ...
        if (obj instanceof SetFuture) {
            ...
            if (strEmptyToNull != null) {
                Fragment$$ExternalSyntheticOutline1.m67m(sb, ", info=[", strEmptyToNull, "]");
            }
        }
        if (isDone()) {
