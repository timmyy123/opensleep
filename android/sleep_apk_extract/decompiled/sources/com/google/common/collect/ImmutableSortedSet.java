...
public abstract class ImmutableSortedSet<E> extends ImmutableSortedSetFauxverideShim<E> implements NavigableSet<E>, SortedIterable<E> {
    ...
    public static <E> ImmutableSortedSet<E> construct(Comparator<? super E> comparator, int i, E... eArr) {
        ...
        for (int i3 = 1; i3 < i; i3++) {
            OggIO$$ExternalSyntheticBUOutline0 oggIO$$ExternalSyntheticBUOutline0 = (Object) eArr[i3];
            if (comparator.compare(oggIO$$ExternalSyntheticBUOutline0, (Object) eArr[i2 - 1]) != 0) {
                eArr[i2] = oggIO$$ExternalSyntheticBUOutline0;
                i2++;
            }
        }
