...
public abstract class DescriptorUtils {
    ...
    public static ClassDescriptor getClassDescriptorForTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassDescriptor classDescriptor = (ClassDescriptor) typeConstructor.mo2510getDeclarationDescriptor();
    ...
    public static ClassDescriptor getSuperClassDescriptor(ClassDescriptor classDescriptor) {
        ...
        Iterator<KotlinType> it = classDescriptor.getTypeConstructor().mo2511getSupertypes().iterator();
        while (it.hasNext()) {
    ...
    private static boolean isSameClass(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        DeclarationDescriptor original = classifierDescriptorMo2510getDeclarationDescriptor.getOriginal();
    ...
    public static boolean isSubtypeOfClass(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        Iterator<KotlinType> it = kotlinType.getConstructor().mo2511getSupertypes().iterator();
        while (it.hasNext()) {
    ...
    public static <D extends CallableMemberDescriptor> D unwrapFakeOverride(D d) {
        ...
        while (d.getKind() == CallableMemberDescriptor.Kind.FAKE_OVERRIDE) {
            ...
            if (overriddenDescriptors.isEmpty()) {
                Home$$ExternalSyntheticBUOutline0.m$2("Fake override should have at least one overridden descriptor: ", d);
                return null;
            }
    ...
    public static ModuleDescriptor getContainingModuleOrNull(KotlinType kotlinType) {
        ...
        return getContainingModuleOrNull(classifierDescriptorMo2510getDeclarationDescriptor);
    }
}
