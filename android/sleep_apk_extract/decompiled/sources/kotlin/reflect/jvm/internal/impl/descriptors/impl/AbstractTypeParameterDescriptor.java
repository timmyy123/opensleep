...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    public class TypeParameterTypeConstructor extends AbstractTypeConstructor {
        ...
        public void reportSupertypeLoopError(KotlinType kotlinType) {
            ...
            this.this$0.mo2513reportSupertypeLoopError(kotlinType);
        }
    ...
    public List<KotlinType> getUpperBounds() {
        List<KotlinType> listMo2511getSupertypes = ((TypeParameterTypeConstructor) getTypeConstructor()).mo2511getSupertypes();
        if (listMo2511getSupertypes == null) {
            $$$reportNull$$$0(8);
        }
        return listMo2511getSupertypes;
    }
    ...
    public abstract void mo2513reportSupertypeLoopError(KotlinType kotlinType);
