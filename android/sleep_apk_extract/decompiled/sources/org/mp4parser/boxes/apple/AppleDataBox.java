...
public abstract class AppleDataBox extends AbstractBox {
    ...
    static {
        ...
        language = map;
        map.put(AppEventsConstants.EVENT_PARAM_VALUE_NO, "English");
    ...
    private static /* synthetic */ void ajc$preClinit() {
        ...
        ajc$tjp_0 = factory.makeSJP("method-execution", factory.makeMethodSig(AppEventsConstants.EVENT_PARAM_VALUE_YES, "getLanguageString", "org.mp4parser.boxes.apple.AppleDataBox", "", "", "", "java.lang.String"), 138);
        ajc$tjp_1 = factory.makeSJP("method-execution", factory.makeMethodSig(AppEventsConstants.EVENT_PARAM_VALUE_YES, "getDataType", "org.mp4parser.boxes.apple.AppleDataBox", "", "", "", "int"), 156);
        ajc$tjp_2 = factory.makeSJP("method-execution", factory.makeMethodSig(AppEventsConstants.EVENT_PARAM_VALUE_YES, "getDataCountry", "org.mp4parser.boxes.apple.AppleDataBox", "", "", "", "int"), 160);
        ajc$tjp_3 = factory.makeSJP("method-execution", factory.makeMethodSig(AppEventsConstants.EVENT_PARAM_VALUE_YES, "setDataCountry", "org.mp4parser.boxes.apple.AppleDataBox", "int", "dataCountry", "", "void"), 164);
        ajc$tjp_4 = factory.makeSJP("method-execution", factory.makeMethodSig(AppEventsConstants.EVENT_PARAM_VALUE_YES, "getDataLanguage", "org.mp4parser.boxes.apple.AppleDataBox", "", "", "", "int"), 168);
        ajc$tjp_5 = factory.makeSJP("method-execution", factory.makeMethodSig(AppEventsConstants.EVENT_PARAM_VALUE_YES, "setDataLanguage", "org.mp4parser.boxes.apple.AppleDataBox", "int", "dataLanguage", "", "void"), 172);
    }
    ...
    public ByteBuffer parseDataLength4ccTypeCountryLanguageAndReturnRest(ByteBuffer byteBuffer) {
        ...
        this.dataCountry = s;
        if (s < 0) {
            this.dataCountry = s + NativeProtocol.MESSAGE_GET_ACCESS_TOKEN_REQUEST;
        }
        short s2 = byteBuffer.getShort();
        this.dataLanguage = s2;
        if (s2 < 0) {
            this.dataLanguage = s2 + NativeProtocol.MESSAGE_GET_ACCESS_TOKEN_REQUEST;
        }
        int i2 = i - 16;
